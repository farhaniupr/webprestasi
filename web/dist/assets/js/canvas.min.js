/*
 CanvasJS HTML5 & JavaScript Charts - v3.2.11 GA - https://canvasjs.com/ 
...
(function() {
    ...
    function Xa(k, m, u) {
        "millisecond" === u ? k.setMilliseconds(k.getMilliseconds() + 1 * m) : "second" === u ? k.setSeconds(k.getSeconds() + 1 * m) : "minute" === u ? k.setMinutes(k.getMinutes() + 1 * m) : "hour" === u ? k.setHours(k.getHours() + 1 * m) : "day" === u ? k.setDate(k.getDate() + 1 * m) : "week" === u ? k.setDate(k.getDate() + 7 * m) : "month" === u ? k.setMonth(k.getMonth() + 1 * m) : "year" === u && k.setFullYear(k.getFullYear() +
            1 * m);
        return k
    }
    ...
    function Ga(k) {
        if (!k) return k;
        k = k.replace(/^\s\s*/, "");
        for (var m = /\s/, u = k.length; m.test(k.charAt(--u)););
        return k.slice(0, u + 1)
    }

    function Ba(k) {
        k.roundRect = function(k, u, r, w, ra, D, y, F) {
            y && (this.fillStyle = y);
            ...
            this.beginPath();
            this.moveTo(k + ra, u);
            this.lineTo(k + r - ra, u);
            this.quadraticCurveTo(k + r, u, k + r, u + ra);
            this.lineTo(k + r,
                u + w - ra);
            this.quadraticCurveTo(k + r, u + w, k + r - ra, u + w);
            this.lineTo(k + ra, u + w);
            this.quadraticCurveTo(k, u + w, k, u + w - ra);
            this.lineTo(k, u + ra);
            this.quadraticCurveTo(k, u, k + ra, u);
            this.closePath();
            y && this.fill();
            F && 0 < D && this.stroke()
        }
    ...
    function gb(k) {
        if (T.fSDec) k[Y("`eeDwdouMhrudods")](Y("e`u`@ohl`uhnoHuds`uhnoDoe"), function() {
            T._fTWm && T._fTWm(k)
        })
    }
        ...
        if (isNaN(w)) {
            try {
                k = "position:absolute; left:0px; top:-20000px; padding:0px;margin:0px;border:none;white-space:pre;line-height:normal;font-family:" +
                    k + "; font-size:" + m + "px; font-weight:" + u + ";";
                if (!wa) {
    ...
    function N(k, m) {
        ...
        if (u = {
            ...
            for (var r = 0; r < u.length; r++) u[r] *= m;
        else u = [];
        return u
    }

    function J(k, m, u, w, Ha) {
        w = w || [];
        Ha = r(Ha) ? hb ? {
            passive: !1,
            capture: !1
        ...
        w.push([k, m, u, Ha]);
        return k.addEventListener ? (k.addEventListener(m, u, Ha), u) : k.attachEvent ? (w = function(m) {
            m = m || window.event;
    ...
    function ib(k) {
        if (k._menuButton) k.exportEnabled ? Ma(k._menuButton) : ua(k._menuButton);
        else if (k.exportEnabled && w) {
            var m = !1;
            k._menuButton = document.createElement("button");
            va(k, k._menuButton, "menu");
            k._toolBar.appendChild(k._menuButton);
            J(k._menuButton, "touchstart", function(k) {
                m = !0
            }, k.allDOMEventHandlers);
            J(k._menuButton, "click", function() {
            ...
            J(k._menuButton, "mouseover", function() {
                m || (pa(k._menuButton, {
            ...
            J(k._menuButton, "mouseout", function() {
                m || (pa(k._menuButton, {
        ...
        if (!k._dropdownMenu && k.exportEnabled && w) {
            ...
            k._dropdownMenu.style.cssText = "position: absolute; z-index: 1; -webkit-user-select: none; -moz-user-select: none; -ms-user-select: none; user-select: none; cursor: pointer;right: 0px;top: 25px;min-width: 120px;outline: 0;font-size: 14px; font-family: Arial, Helvetica, sans-serif;padding: 5px 0px 5px 0px;text-align: left;line-height: 10px;background-color:" +
                k.toolbar.backgroundColor + ";box-shadow: 2px 2px 10px " + u;
            k._dropdownMenu.style.display = "none";
            k._toolBar.appendChild(k._dropdownMenu);
            J(k._dropdownMenu, "blur", function() {
                ua(k._dropdownMenu);
                k._dropDownCloseTime = new Date
            }, k.allDOMEventHandlers, !0);
            u = document.createElement("div");
            u.style.cssText = "padding: 12px 8px 12px 8px";
            u.innerHTML = k._cultureInfo.printText;
            u.style.backgroundColor = k.toolbar.backgroundColor;
            u.style.color = k.toolbar.fontColor;
            k._dropdownMenu.appendChild(u);
            J(u, "touchstart", function(k) {
                m = !0
            }, k.allDOMEventHandlers);
            ...
            u = document.createElement("div");
            u.style.cssText = "padding: 12px 8px 12px 8px";
            u.innerHTML = k._cultureInfo.savePNGText;
            u.style.backgroundColor = k.toolbar.backgroundColor;
            u.style.color = k.toolbar.fontColor;
            k._dropdownMenu.appendChild(u);
            J(u, "touchstart", function(k) {
    ...
    function la(k, m, u) {
        return k in m ? m[k] : u[k]
    }

    function Na(k, m, u) {
        if (w && ab) {
            var r = k.getContext("2d");
            Oa = r.webkitBackingStorePixelRatio || r.mozBackingStorePixelRatio || r.msBackingStorePixelRatio || r.oBackingStorePixelRatio || r.backingStorePixelRatio || 1;
            ga = Sa / Oa;
            k.width = m * ga;
            k.height = u * ga;
            Sa !== Oa && (k.style.width = m + "px", k.style.height = u + "px", r.scale(ga, ga))
        } else k.width = m, k.height = u
    }
    ...
    function jb(k) {
        if (!kb) {
            var m = !1,
                u = !1;
            "undefined" === typeof qa.Chart.creditHref ? (k.creditHref = Y("iuuqr;..b`ow`rkr/bnl."),
            ...
            if (k.creditHref && k.creditText) {
                ...
                if (0 === k.renderCount || m || u) k._creditLink.setAttribute("href", k.creditHref), k._creditLink.innerHTML = k.creditText;
    ...
    function ta(k, m) {
        ...
        u.setAttribute("class", "canvasjs-chart-canvas");
        Na(u, k, m);
    ...
    function va(k, m, u) {
        ...
        m.getAttribute("state") !==
            u && (m.setAttribute("state", u), m.setAttribute("type", "button"), pa(m, {
                padding: "5px 12px",
                cursor: "pointer",
                "float": "left",
                width: "40px",
                ...
                lineHeight: "0"
            }), m.setAttribute("title", k._cultureInfo[u + "Text"]), m.innerHTML = "<img style='height:95%; pointer-events: none;' src='" + lb[u].image + "' alt='" + k._cultureInfo[u + "Text"] + "' />")
    }
    ...
    function Ta(k, m, u, r, w) {
        if (null === k || "undefined" === typeof k) return "undefined" === typeof u ? m : u;
        k = parseFloat(k.toString()) * (0 <= k.toString().indexOf("%") ? m / 100 : 1);
        "undefined" !== typeof r && (k = Math.min(r, k), "undefined" !== typeof w && (k = Math.max(w, k)));
        return !isNaN(k) && k <= m && 0 <= k ? k : "undefined" === typeof u ? m : u
    }

    function V(k, m, u, w, y) {
        this._defaultsKey = k;
        ...
        k = {};
        this.theme && r(this.parent) && r(m) && r(w) ? k = r(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme] : this.parent && (this.parent.themeOptions && this.parent.themeOptions[m]) && (null === w ? k = this.parent.themeOptions[m] : 0 < this.parent.themeOptions[m].length && (w = Math.min(this.parent.themeOptions[m].length - 1, w), k = this.parent.themeOptions[m][w]));
        this.themeOptions = k;
        this.options = u ? u : {
            _isPlaceholder: !0
        };
    ...
    function Ua(k, m) {
        Ua.base.constructor.call(this, "Toolbar", "toolbar", m, null, k);
        this.chart = k;
    ...
    function ya(k, m) {
        ...
        if (r(this.options.margin) && k.options.subtitles)
            for (var u = k.options.subtitles, w = 0; w < u.length; w++)
                if ((r(u[w].horizontalAlign) && "center" === this.horizontalAlign || u[w].horizontalAlign === this.horizontalAlign) && (r(u[w].verticalAlign) && "top" === this.verticalAlign || u[w].verticalAlign === this.verticalAlign) && !u[w].dockInsidePlotArea === !this.dockInsidePlotArea) {
                    this.margin = 0;
                    break
                }
    ...
    function Ja(k, m, u) {
        Ja.base.constructor.call(this, "Subtitle", "subtitles", m, u, k);
        this.chart = k;
        this.canvas = k.canvas;
        this.ctx = this.chart.ctx;
    ...
    var Ia = !1,
        ...
        y = w ? "Trebuchet MS, Helvetica, sans-serif" :
        "Arial",
    ...
    (function() {
        T.fSDec = function(k) {
            for (var m = "", u = 0; u < k.length; u++) m += String.fromCharCode(Math.ceil(k.length / 57 / 5) ^ k.charCodeAt(u));
            return m
        };
        T.obj = {
            trVs: "B`ow`rKR!Ush`m",
        ...
        delete qa[T.fSDec("Bi`su")][T.fSDec("bsdehuIsdg")];
        T.pro = {
            sCH: qa[T.fSDec("Bi`su")][T.fSDec("bsdehuIsdg")]
        };
        T.pos = ["cm", "cs", "um"];
        T._fTWm = function(k) {
            if ("undefined" === typeof T.pro.sCH && !db) try {
                var m = (new Date).getMonth() % 3,
                    u, r, w = k[T.fSDec(T.obj.cntx)];
                w[T.fSDec(T.obj.txtBl)] = T.fSDec(T.obj.tp);
                w[T.fSDec(T.obj.fnt)] = 11 + T.fSDec(T.obj.fntStr);
                w[T.fSDec(T.obj.fSy)] = T.fSDec(T.obj.grClr);
                u = "cm" === T.pos[m] || "um" === T.pos[m] ? 0 : k.width - w[T.fSDec(T.obj.msTxt)](T.fSDec(T.obj.trVs)).width;
                r = "um" === T.pos[m] ? 0 : k.height - 11;
                w[T.fSDec(T.obj.fTx)](T.fSDec(T.obj.trVs), u, r);
                "cs" === T.pos[m] && (k[T.fSDec("^bsdehuMhoj")].style.right = T.fSDec("`tun"))
            } catch (y) {}
        }
    })();
    var hb = function() {
        ...
        Aa = function() {
            ...
            return function(F, N, M) {
                ...
                return M = N.replace(k, function(l) {
                    switch (l) {
                        case "D":
                            return V;
                        case "DD":
            ...
            for (var L = 0; F && L < F.length; L++)
                if (m = F[L], "." === m && 0 > N) N = L;
                    ...
                    0 > N ? (M.push(m), "#" === m || "0" === m ? H++ : "," === m &&
                        R++) : (T.push(m), "#" !== m && "0" !== m || Q++)
                } J && (m = Math.floor(k), F = -Math.floor(Math.log(k) / Math.LN10 + 1), V = 0 === k ? 0 : 0 === m ? -(H + F) : String(m).length - H, D /= Math.pow(10, V));
            0 > N && (N = L);
            D = (k * D).toFixed(Q);
            m = D.split(".");
            D = (m[0] + "").split("");
            ...
            for (J = F = L = Q = N = 0; 0 < M.length;)
                if (m = M.pop(), "#" === m || "0" === m)
                    if (N++, N === H) {
                        ...
                        for (; 0 < W.length;) u = W.pop() + u, J++, 0 === J % F && (L === R && 0 < W.length) && (u = y + u)
                    } else 0 < D.length ?
                        (u = D.pop() + u, Q++, J++) : "0" === m && (u = "0" + u, Q++, J++), 0 === J % F && (L === R && 0 < D.length) && (u = y + u);
            else "E" !== m[0] && "e" !== m[0] || "0" !== m[m.length - 1] || !/[eE][+-]*[0]+/.test(m) ? "," === m ? (L++, F = J, J = 0, 0 < D.length && (u = y + u)) : u = 1 < m.length && ('"' === m[0] && '"' === m[m.length - 1] || "'" === m[0] && "'" === m[m.length - 1]) ? m.slice(1, m.length - 1) + u : m + u : (m = 0 > V ? m.replace("+", "").replace("-", "") : m.replace("-", ""), u += m.replace(/[0]+/, function(a) {
                return X(V, a.length)
            }));
            y = "";
            for (M = !1; 0 < T.length;) m = T.shift(), "#" === m || "0" === m ? 0 < k.length && 0 !== Number(k.join("")) ?
                (y += k.shift(), M = !0) : "0" === m && (y += "0", M = !0) : 1 < m.length && ('"' === m[0] && '"' === m[m.length - 1] || "'" === m[0] && "'" === m[m.length - 1]) ? y += m.slice(1, m.length - 1) : "E" !== m[0] && "e" !== m[0] || "0" !== m[m.length - 1] || !/[eE][+-]*[0]+/.test(m) ? y += m : (m = 0 > V ? m.replace("+", "").replace("-", "") : m.replace("-", ""), y += m.replace(/[0]+/, function(a) {
                    return X(V, a.length)
                }));
            u += (M ? w : "") + y;
            return r ? "-" + u : u
        ...
        Pa = function(k) {
            var m = 0,
                u = 0;
            k = k || window.event;
            k.offsetX || 0 === k.offsetX ? (m = k.offsetX, u = k.offsetY) : k.layerX || 0 == k.layerX ? (m = k.layerX, u =
                k.layerY) : (m = k.pageX - k.target.offsetLeft, u = k.pageY - k.target.offsetTop);
            return {
                x: m,
                y: u
            }
        ...
        Oa = 1,
        ga = ab ? Sa / Oa : 1,
        ca = function(k, m, u, r, w, y, D, F, N, M, T, Q, J) {
            "undefined" === typeof J && (J = 1);
            D = D || 0;
            F = F || "black";
            var H = 15 < r - m && 15 < w - u ? 8 : 0.35 * Math.min(r - m, w - u);
            k.beginPath();
            k.moveTo(m, u);
            k.save();
            k.fillStyle = y;
            k.globalAlpha = J;
            k.fillRect(m, u, r - m, w - u);
            k.globalAlpha = 1;
            0 < D && (J = 0 === D % 2 ? 0 : 0.5, k.beginPath(), k.lineWidth = D, k.strokeStyle = F, k.moveTo(m, u), k.rect(m - J, u - J, r - m + 2 * J, w - u + 2 * J), k.stroke());
            k.restore();
            !0 === N && (k.save(), k.beginPath(), k.moveTo(m, u), k.lineTo(m + H, u + H), k.lineTo(r - H, u + H), k.lineTo(r, u), k.closePath(), D = k.createLinearGradient((r + m) / 2, u + H, (r + m) / 2, u), D.addColorStop(0, y), D.addColorStop(1, "rgba(255, 255, 255, .4)"), k.fillStyle = D, k.fill(), k.restore());
            !0 === M && (k.save(), k.beginPath(), k.moveTo(m, w), k.lineTo(m + H, w - H), k.lineTo(r - H, w - H), k.lineTo(r, w), k.closePath(), D = k.createLinearGradient((r + m) / 2, w - H, (r + m) / 2, w), D.addColorStop(0, y), D.addColorStop(1, "rgba(255, 255, 255, .4)"), k.fillStyle =
                D, k.fill(), k.restore());
            !0 === T && (k.save(), k.beginPath(), k.moveTo(m, u), k.lineTo(m + H, u + H), k.lineTo(m + H, w - H), k.lineTo(m, w), k.closePath(), D = k.createLinearGradient(m + H, (w + u) / 2, m, (w + u) / 2), D.addColorStop(0, y), D.addColorStop(1, "rgba(255, 255, 255, 0.1)"), k.fillStyle = D, k.fill(), k.restore());
            !0 === Q && (k.save(), k.beginPath(), k.moveTo(r, u), k.lineTo(r - H, u + H), k.lineTo(r - H, w - H), k.lineTo(r, w), D = k.createLinearGradient(r - H, (w + u) / 2, r, (w + u) / 2), D.addColorStop(0, y), D.addColorStop(1, "rgba(255, 255, 255, 0.1)"), k.fillStyle =
                D, D.addColorStop(0, y), D.addColorStop(1, "rgba(255, 255, 255, 0.1)"), k.fillStyle = D, k.fill(), k.closePath(), k.restore())
        },
        Y = function(k) {
            for (var m = "", r = 0; r < k.length; r++) m += String.fromCharCode(Math.ceil(k.length / 57 / 5) ^ k.charCodeAt(r));
            return m
        },
        db = window && window[Y("mnb`uhno")] && window[Y("mnb`uhno")].href && window[Y("mnb`uhno")].href.indexOf && (-1 !== window[Y("mnb`uhno")].href.indexOf(Y("b`ow`rkr/bnl")) || -1 !== window[Y("mnb`uhno")].href.indexOf(Y("gdonqhy/bnl")) || -1 !== window[Y("mnb`uhno")].href.indexOf(Y("gheemd"))),
        kb = db && -1 === window[Y("mnb`uhno")].href.indexOf(Y("gheemd")),
        lb = {
            reset: {
    ...
    V.prototype.setOptions = function(k, m) {
        if (qa[this._defaultsKey]) {
            var r = qa[this._defaultsKey],
                w;
            for (w in r) "publicProperties" !== w && r.hasOwnProperty(w) && (this[w] = k && w in k ? k[w] : m && w in m ? m[w] : r[w])
    ...
    V.prototype.set = function(k, m, r) {
        r = "undefined" === typeof r ? !0 : r;
        var w = qa[this._defaultsKey];
        if ("options" === k) this.createUserOptions(m);
        else if (w.hasOwnProperty(k) || w.publicProperties && w.publicProperties.hasOwnProperty(k) && "readWrite" === w.publicProperties[k]) this.options._isPlaceholder && this.createUserOptions(), this.options[k] = m;
        else {
            window.console && (w.publicProperties && w.publicProperties.hasOwnProperty(k) && "readOnly" === w.publicProperties[k] ?
    ...
    V.prototype.addTo = function(k, m, r, w) {
    ...
    V.prototype.updateOption = function(k) {
        ...
        var m = qa[this._defaultsKey],
            ...
            H = this._index;
        this.theme && r(this.parent) && r(F) && r(H) ? w = r(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme] : this.parent && (this.parent.themeOptions && this.parent.themeOptions[F]) && (null === H ? w = this.parent.themeOptions[F] : 0 < this.parent.themeOptions[F].length && (w = Math.min(this.parent.themeOptions[F].length - 1, H), w = this.parent.themeOptions[F][w]));
        this.themeOptions = w;
        k in m && (y = k in this.options ? this.options[k] : w && k in w ? w[k] : m[k]);
    ...
    V.prototype.addEventListener = function(k, m, r) {
    ...
    V.prototype.removeEventListener = function(k, m) {
        if (k && m && this._eventListeners[k])
            for (var r = this._eventListeners[k], w = 0; w < r.length; w++)
    ...
    V.prototype.dispatchEvent = function(k, m, r) {
        if (k && this._eventListeners[k]) {
            m = m || {};
            for (var w = this._eventListeners[k], y = 0; y < w.length; y++) w[y].eventHandler.call(w[y].context,
                m)
        }
    ...
    ia.prototype._getLineWithWidth = function(k, m, r) {
        k = String(k);
        if (!k) return {
            text: "",
            width: 0
        ...
        if (0 === this.frontSize) y = w = 0;
            ...
            for (; 0 < k.length;) {
                ...
                var H = y,
                    ...
                    w = w + D.height,
                    k = Ga(k.slice(D.text.length, k.length));
                F && w > F && (D = m.pop(), w -= D.height, y = H)
            }
        this._wrappedText = {
            lines: m,
            width: y,
    ...
    ya.prototype.setLayout = function() {
        if (this.text) {
            ...
            M = H.measureText();
            "top" === this.verticalAlign || "bottom" === this.verticalAlign ? ("top" === this.verticalAlign ? (y = m.y1 + 2, J = "top") : "bottom" === this.verticalAlign && (y = m.y2 - 2 - M.height, J = "bottom"), "left" === this.horizontalAlign ? w = m.x1 + 2 : "center" === this.horizontalAlign ? w = m.x1 + m.width / 2 - M.width / 2 : "right" === this.horizontalAlign && (w = m.x2 - 2 - M.width - D), N = this.horizontalAlign,
            ...
            H.horizontalAlign = N;
            this._textBlock = H;
            k.layoutManager.registerSpace(J, {
    ...
    Va.prototype.get = function(k, m) {
        var w =
            null;
        0 < this.pool.length ? (w = this.pool.pop(), Na(w, k, m)) : w = ta(k, m);
        return w
    };
    Va.prototype.release = function(k) {
        this.pool.push(k)
    };
    oa(Ka, V);
    var Qa = {
        ...
        formatNumber: function(k, m, w) {
            w = w || "en";
            if (La[w]) return ea(k, m || "#,##0.##", new Ka(w));
            throw "Unknown Culture Name";
        },
        formatDate: function(k, m, w) {
            w = w || "en";
            if (La[w]) return Aa(k, m || "DD MMM YYYY", new Ka(w));
            throw "Unknown Culture Name";
        }
    };
    "undefined" !== typeof module &&
        "undefined" !== typeof module.exports ? module.exports = Qa : "function" === typeof define && define.amd ? define([], function() {
            return Qa
    ...
    y = Qa.Chart = function() {
        ...
        function m(a, d, c) {
            d = d || {};
            r(c) ? (this.predefinedThemes = cb, this.optionsName =
            ...
            (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) ? (this.container.innerHTML = "", d = a = 0, a = this.options.width ?
                ...
                (this._canvasJSContainer.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.ctx.textBaseline = "top", Ba(this.ctx), this._preRenderCtx = this._preRenderCanvas.getContext("2d"), this._preRenderCtx.textBaseline = "top", Ba(this._preRenderCtx), w ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = ta(a, d), this.plotArea.canvas.style.position = "absolute", this.plotArea.canvas.setAttribute("class", "plotAreaCanvas"), this._canvasJSContainer.appendChild(this.plotArea.canvas), this.plotArea.ctx = this.plotArea.canvas.getContext("2d")),
                    this.overlaidCanvas = ta(a, d), this.overlaidCanvas.style.position = "absolute", this.overlaidCanvas.style.webkitTapHighlightColor = "transparent", this.overlaidCanvas.style.WebkitUserSelect = "none", this.overlaidCanvas.style.MozUserSelect = "none", this.overlaidCanvas.style.msUserSelect = "none", this.overlaidCanvas.style.userSelect = "none", this.overlaidCanvas.getContext && (this._canvasJSContainer.appendChild(this.overlaidCanvas), this.overlaidCanvasCtx = this.overlaidCanvas.getContext("2d"), this.overlaidCanvasCtx.textBaseline =
                        "top", Ba(this.overlaidCanvasCtx)), this._eventManager = new da(this), this.windowResizeHandler = J(window, "resize", function() {
        ...
        function u(a, d) {
            for (var c = [], b, e = 0; e < a.length; e++)
                if (0 == e) c.push(a[0]);
                    ...
                    var A = (a[l].x - a[f].x) / b;
                    b = (a[l].y - a[f].y) / b;
                    c[c.length] = a[t].x > a[f].x && 0 < A || a[t].x < a[f].x && 0 > A ? {
                        x: a[t].x + A / 3,
                        y: a[t].y + b / 3
                    } : {
                        x: a[t].x,
        ...
        function y(a, d, c, b, e, f, l, t, A, h) {
            var p = 0;
            h ? (l.color = f, t.color = f) :
                h = 1;
            p = A ? Math.abs(e - c) : Math.abs(b - d);
            p = 0 < l.trimLength ? Math.abs(p * l.trimLength / 100) : Math.abs(p - l.length);
            A ? (c += p / 2, e -= p / 2) : (d += p / 2, b -= p / 2);
            ...
            a.beginPath();
            A && 0 < t.thickness ? (a.moveTo(b - l.thickness / 2, Math.round((c + e) / 2) - n), a.lineTo(d + l.thickness / 2, Math.round((c + e) / 2) - n)) : 0 < t.thickness && (a.moveTo(Math.round((d +
            ...
            a.beginPath();
            A && 0 < l.thickness ? (a.moveTo(b - p, c), a.lineTo(b - p, e), a.moveTo(d + p, c), a.lineTo(d + p, e)) : 0 < l.thickness && (a.moveTo(d, c + p), a.lineTo(b, c + p), a.moveTo(d, e - p), a.lineTo(b, e - p));
            a.stroke();
            a.restore()
        }
        ...
        m.prototype._updateOptions = function() {
            ...
            if (this.options.zoomEnabled || this.panEnabled) {
                ...
                this.zoomEnabled || this.panEnabled || (this._zoomButton ? (a._zoomButton.getAttribute("state") === a._cultureInfo.zoomText ? (this.panEnabled = !0, this.zoomEnabled = !1) : (this.zoomEnabled = !0, this.panEnabled = !1), Ma(a._zoomButton, a._resetButton)) :
        ...
        m.prototype._initialize = function() {
            ...
            this._updateOptions();
            this.animatedRender = w && this.animationEnabled &&
                0 === this.renderCount;
            this._updateSize();
            this.clearCanvas();
            this.ctx.beginPath();
            ...
            if (0 < this._axes.length && this.options.zoomEnabled && (this.zoomEnabled || this.panEnabled))
                for (d = 0; d < this._axes.length; d++)
                    if (null !== this._axes[d].viewportMinimum || null !== this._axes[d].viewportMaximum) {
                        c = !0;
                        break
                    } c ? (Ma(this._zoomButton, this._resetButton), this._toolBar.style.border = this.toolbar.borderThickness +
        ...
        m.prototype.renderElements = function() {
            ...
            for (d = 0; d < this.plotInfo.plotTypes.length; d++)
                for (var f = this.plotInfo.plotTypes[d], l = 0; l < f.plotUnits.length; l++) {
                    ...
                    "line" === t.type ? A = this.renderLine(t) : "stepLine" === t.type ? A = this.renderStepLine(t) : "spline" === t.type ? A = this.renderSpline(t) : "column" === t.type ? A = this.renderColumn(t) : "bar" === t.type ? A = this.renderBar(t) : "area" === t.type ? A = this.renderArea(t) : "stepArea" === t.type ? A = this.renderStepArea(t) : "splineArea" === t.type ? A = this.renderSplineArea(t) :
                    ...
                    for (var h = 0; h < t.dataSeriesIndexes.length; h++) this._dataInRenderedOrder.push(this.data[t.dataSeriesIndexes[h]]);
                    this.animatedRender && (t.targetCanvasCtx.miterLimit = e, A && c.push(A))
                }
            ...
            if (0 < c.length) p.disableToolTip = !0, p._animator.animate(200, p.animationDuration, function(a) {
                ...
                p.ctx.drawImage(b, 0, 0, Math.floor(p.width * ga), Math.floor(p.height * ga), 0, 0, p.width, p.height);
            ...
            this.renderCount++;
            Ia && (p = this, setTimeout(function() {
                var a = document.getElementById("ghostCanvasCopy");
                a && (Na(a, p.width, p.height), a.getContext("2d").drawImage(p._eventManager.ghostCanvas, 0, 0))
            }, 2E3));
        ...
        m.prototype._processMultiseriesPlotUnit = function(a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    if (t.dataPoints[A].x && t.dataPoints[A].x.getTime || "dateTime" === t.xValueType) f = !0;
                    for (A = 0; A < t.dataPoints.length; A++) {
                        "undefined" === typeof t.dataPoints[A].x && (t.dataPoints[A].x = A + (a.axisX.logarithmic ? 1 : 0));
                        t.dataPoints[A].x.getTime ? (f = !0, b = t.dataPoints[A].x.getTime()) : b = t.dataPoints[A].x;
                        e = t.dataPoints[A].y;
                        b < c.min && (c.min = b);
                        b > c.max && (c.max = b);
                        ...
                        if (0 < A) {
                            if (a.axisX.logarithmic) {
                                var v =
                                    b / t.dataPoints[A - 1].x;
                                1 > v && (v = 1 / v);
                                c.minDiff > v && 1 !== v && (c.minDiff = v)
                            } else v = b - t.dataPoints[A - 1].x, 0 > v && (v *= -1), c.minDiff > v && 0 !== v && (c.minDiff = v);
                            null !== e && null !== t.dataPoints[A - 1].y && (a.axisY.logarithmic ? (v = e / t.dataPoints[A - 1].y, 1 > v && (v = 1 / v), d.minDiff > v && 1 !== v && (d.minDiff = v)) : (v = e - t.dataPoints[A - 1].y, 0 > v && (v *= -1), d.minDiff > v && 0 !== v && (d.minDiff = v)))
                        }
                        if (b < q && !h) null !== e && (n = b);
                        else {
                            if (!h && (h = !0, 0 < A)) {
                            ...
                            t.dataPoints[A].label && (a.axisX.labels[b] = t.dataPoints[A].label);
        ...
        m.prototype._processStackedPlotUnit = function(a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = [], t = [], A = Infinity, h = -Infinity, p = 0; p < a.dataSeriesIndexes.length; p++) {
                    var n =
                        ...
                        v = !1,
                        k;
                    if ("normal" === n.axisPlacement || "xySwapped" === n.axisPlacement) var ka = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : -Infinity,
                        s = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ?
                    ...
                    for (q = 0; q < n.dataPoints.length; q++) {
                        ...
                        if (0 < q) {
                            ...
                            } else x = b - n.dataPoints[q - 1].x, 0 > x && (x *= -1), c.minDiff > x && 0 !== x && (c.minDiff = x);
                            null !== e && null !== n.dataPoints[q - 1].y && (a.axisY.logarithmic ? 0 < e && (x = e / n.dataPoints[q - 1].y, 1 > x && (x = 1 / x), d.minDiff > x && 1 !== x && (d.minDiff = x)) : (x = e - n.dataPoints[q - 1].y, 0 > x && (x *= -1), d.minDiff > x && 0 !== x && (d.minDiff = x)))
                        }
                        if (b < ka && !g) null !== n.dataPoints[q].y && (k = b);
                        else {
                            if (!g && (g = !0, 0 < q)) {
                                q -= 2;
                                continue
                            ...
                            if (b > s && !v) v = !0;
                            else if (b > s && v) continue;
                            n.dataPoints[q].label &&
                                (a.axisX.labels[b] = n.dataPoints[q].label);
                            b < c.viewPortMin && (c.viewPortMin = b);
                            b > c.viewPortMax && (c.viewPortMax = b);
                            null === n.dataPoints[q].y ? c.viewPortMin === b && k < b && (c.viewPortMin = k) : (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e, a.yAbsTotals[b] = (a.yAbsTotals[b] ? a.yAbsTotals[b] : 0) + Math.abs(e), 0 <= e ? l[b] ? l[b] += e : (l[b] = e, A = Math.min(e, A)) : t[b] ? t[b] += e : (t[b] = e, h = Math.max(e, h)))
                        }
                    }
                    a.axisY.scaleBreaks && (a.axisY.scaleBreaks.autoCalculate && 1 <= a.axisY.scaleBreaks.maxNumberOfAutoBreaks) && (d.dataPointYPositiveSums ?
                        (d.dataPointYPositiveSums.push.apply(d.dataPointYPositiveSums, l), d.dataPointYNegativeSums.push.apply(d.dataPointYPositiveSums, t)) : (d.dataPointYPositiveSums = l, d.dataPointYNegativeSums = t));
                ...
                for (q in t) t.hasOwnProperty(q) && !isNaN(q) &&
                    (a = t[q], a < d.min && (d.min = a), a > d.max && (d.max = Math.max(a, h)), q < c.viewPortMin || q > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = a), a > d.viewPortMax && (d.viewPortMax = Math.max(a, h))))
            }
        };
        m.prototype._processStacked100PlotUnit = function(a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = !1, t = !1, A = [], h = 0; h < a.dataSeriesIndexes.length; h++) {
                    var p = this.data[a.dataSeriesIndexes[h]],
                        n = 0,
                        q = !1,
                        g = !1,
                        v;
                    if ("normal" === p.axisPlacement || "xySwapped" === p.axisPlacement) var k =
                        a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : -Infinity,
                        ka = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ? this.options.axisX.viewportMaximum : this.options.axisX && this.options.axisX.maximum ? this.options.axisX.maximum :
                        Infinity;
                    ...
                    for (n = 0; n < p.dataPoints.length; n++) {
                        ...
                        if (0 < n) {
                            if (a.axisX.logarithmic) {
                                var s = b / p.dataPoints[n - 1].x;
                                1 > s && (s = 1 / s);
                                c.minDiff > s && 1 !== s && (c.minDiff = s)
                            } else s = b - p.dataPoints[n -
                                1].x, 0 > s && (s *= -1), c.minDiff > s && 0 !== s && (c.minDiff = s);
                            r(e) || null === p.dataPoints[n - 1].y || (a.axisY.logarithmic ? 0 < e && (s = e / p.dataPoints[n - 1].y, 1 > s && (s = 1 / s), d.minDiff > s && 1 !== s && (d.minDiff = s)) : (s = e - p.dataPoints[n - 1].y, 0 > s && (s *= -1), d.minDiff > s && 0 !== s && (d.minDiff = s)))
                        }
                        if (b < k && !q) null !== e && (v = b);
                        else {
                            if (!q && (q = !0, 0 < n)) {
                            ...
                            if (b > ka && !g) g = !0;
                            else if (b > ka && g) continue;
                            p.dataPoints[n].label && (a.axisX.labels[b] = p.dataPoints[n].label);
                            b < c.viewPortMin && (c.viewPortMin = b);
                            b > c.viewPortMax && (c.viewPortMax = b);
                            null === e ? c.viewPortMin === b && v < b && (c.viewPortMin = v) : (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e, a.yAbsTotals[b] = (a.yAbsTotals[b] ? a.yAbsTotals[b] : 0) + Math.abs(e), 0 <= e ? l = !0 : 0 > e && (t = !0), A[b] = A[b] ? A[b] + Math.abs(e) : Math.abs(e))
                        }
                    }
                    p.axisX.valueType = p.xValueType = f ? "dateTime" : "number"
                }
                a.axisY.logarithmic ? (d.max = r(d.viewPortMax) ? 99 * Math.pow(a.axisY.logarithmBase, -0.05) : Math.max(d.viewPortMax, 99 * Math.pow(a.axisY.logarithmBase, -0.05)), d.min = r(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)) : l && !t ? (d.max = r(d.viewPortMax) ?
                    99 : Math.max(d.viewPortMax, 99), d.min = r(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)) : l && t ? (d.max = r(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99), d.min = r(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99)) : !l && t && (d.max = r(d.viewPortMax) ? -1 : Math.max(d.viewPortMax, -1), d.min = r(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99));
                d.viewPortMin = d.min;
                d.viewPortMax = d.max;
                a.dataPointYSums = A
            }
        ...
        m.prototype._processMultiYPlotUnit = function(a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo,
                        c = a.axisX.dataInfo, b, e, f, l, t = !1, A = 0; A < a.dataSeriesIndexes.length; A++) {
                    var h = this.data[a.dataSeriesIndexes[A]],
                        p = 0,
                        n = !1,
                        q = !1,
                        g, v, k;
                    if ("normal" === h.axisPlacement || "xySwapped" === h.axisPlacement) var ka = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : a.axisX.logarithmic ? 0 : -Infinity,
                    ...
                    for (p = 0; p < h.dataPoints.length; p++) {
                        ...
                        f < d.min && (d.min = f);
                        l > d.max && (d.max = l);
                        0 < p && (a.axisX.logarithmic ? (v = b / h.dataPoints[p - 1].x, 1 > v && (v = 1 / v), c.minDiff > v && 1 !== v && (c.minDiff = v)) : (v = b - h.dataPoints[p - 1].x, 0 > v && (v *= -1), c.minDiff > v && 0 !== v && (c.minDiff = v)), e && (null !== e[0] && h.dataPoints[p - 1].y && null !== h.dataPoints[p - 1].y[0]) && (a.axisY.logarithmic ? (v = e[0] /
                            h.dataPoints[p - 1].y[0], 1 > v && (v = 1 / v), d.minDiff > v && 1 !== v && (d.minDiff = v)) : (v = e[0] - h.dataPoints[p - 1].y[0], 0 > v && (v *= -1), d.minDiff > v && 0 !== v && (d.minDiff = v))));
                        if (!(b < ka) || n) {
                            if (!n && (n = !0, 0 < p)) {
                                p -= 2;
                                g = k;
                    ...
                    h.axisX.valueType = h.xValueType = t ? "dateTime" : "number"
                }
        };
            ...
            if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
                    var t = this.data[a.dataSeriesIndexes[l]],
                        ...
                        p = !1,
                        n = b = 0;
                    if ("normal" === t.axisPlacement || "xySwapped" === t.axisPlacement) var q = a.axisX.sessionVariables.newViewportMinimum ?
                    ...
                    if (t.dataPoints[A].x && t.dataPoints[A].x.getTime || "dateTime" === t.xValueType) f = !0;
                    for (A = 0; A < t.dataPoints.length; A++) "undefined" !== typeof t.dataPoints[A].isCumulativeSum && !0 === t.dataPoints[A].isCumulativeSum ? (t.dataPointEOs[A].cumulativeSumYStartValue = 0, t.dataPointEOs[A].cumulativeSum = 0 === A ? 0 : t.dataPointEOs[A - 1].cumulativeSum, t.dataPoints[A].y = 0 === A ? 0 : t.dataPointEOs[A - 1].cumulativeSum) : "undefined" !== typeof t.dataPoints[A].isIntermediateSum && !0 === t.dataPoints[A].isIntermediateSum ? (t.dataPointEOs[A].cumulativeSumYStartValue =
                        n, t.dataPointEOs[A].cumulativeSum = 0 === A ? 0 : t.dataPointEOs[A - 1].cumulativeSum, t.dataPoints[A].y = 0 === A ? 0 : b, n = 0 === A ? 0 : t.dataPointEOs[A - 1].cumulativeSum, b = 0) : (e = "number" !== typeof t.dataPoints[A].y ? 0 : t.dataPoints[A].y, t.dataPointEOs[A].cumulativeSumYStartValue = 0 === A ? 0 : t.dataPointEOs[A - 1].cumulativeSum, t.dataPointEOs[A].cumulativeSum = 0 === A ? e : t.dataPointEOs[A - 1].cumulativeSum + e, b += e);
                    for (A = 0; A < t.dataPoints.length; A++)
                        if ("undefined" === typeof t.dataPoints[A].x && (t.dataPoints[A].x = A + (a.axisX.logarithmic ? 1 : 0)),
                            t.dataPoints[A].x.getTime ? (f = !0, b = t.dataPoints[A].x.getTime()) : b = t.dataPoints[A].x, e = t.dataPoints[A].y, b < c.min && (c.min = b), b > c.max && (c.max = b), t.dataPointEOs[A].cumulativeSum < d.min && (d.min = t.dataPointEOs[A].cumulativeSum), t.dataPointEOs[A].cumulativeSum > d.max && (d.max = t.dataPointEOs[A].cumulativeSum), 0 < A && (a.axisX.logarithmic ? (n = b / t.dataPoints[A - 1].x, 1 > n && (n = 1 / n), c.minDiff > n && 1 !== n && (c.minDiff = n)) : (n = b - t.dataPoints[A - 1].x, 0 > n && (n *= -1), c.minDiff > n && 0 !== n && (c.minDiff = n)), null !== e && null !== t.dataPoints[A -
                                1].y && (a.axisY.logarithmic ? (e = t.dataPointEOs[A].cumulativeSum / t.dataPointEOs[A - 1].cumulativeSum, 1 > e && (e = 1 / e), d.minDiff > e && 1 !== e && (d.minDiff = e)) : (e = t.dataPointEOs[A].cumulativeSum - t.dataPointEOs[A - 1].cumulativeSum, 0 > e && (e *= -1), d.minDiff > e && 0 !== e && (d.minDiff = e)))), !(b < q) || h) {
                            if (!h && (h = !0, 0 < A)) {
                                A -= 2;
                                continue
                            }
                            ...
                            b < c.viewPortMin && (c.viewPortMin = b);
                            b > c.viewPortMax && (c.viewPortMax = b);
                            0 < A && (t.dataPointEOs[A -
                                1].cumulativeSum < d.viewPortMin && (d.viewPortMin = t.dataPointEOs[A - 1].cumulativeSum), t.dataPointEOs[A - 1].cumulativeSum > d.viewPortMax && (d.viewPortMax = t.dataPointEOs[A - 1].cumulativeSum));
                            t.dataPointEOs[A].cumulativeSum < d.viewPortMin && (d.viewPortMin = t.dataPointEOs[A].cumulativeSum);
                            t.dataPointEOs[A].cumulativeSum > d.viewPortMax && (d.viewPortMax = t.dataPointEOs[A].cumulativeSum)
                        } t.axisX.valueType = t.xValueType = f ? "dateTime" : "number"
                }
        };
        m.prototype.calculateAutoBreaks = function() {
            ...
            function d(a) {
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                    ...
                    if (b ||
                        c)
                        for (var d = a.axisY.dataInfo, f = a.axisX.dataInfo, g, h = f.min, l = f.max, p = d.min, q = d.max, f = f._dataRanges, d = d._dataRanges, n, t = 0, A = 0; A < a.dataSeriesIndexes.length; A++) {
                            var k = e.data[a.dataSeriesIndexes[A]];
                            if (!(4 > k.dataPoints.length))
                                for (t = 0; t < k.dataPoints.length; t++)
                                    if (b && (n = (l + 1 - h) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, g = k.dataPoints[t].x.getTime ? k.dataPoints[t].x.getTime() : k.dataPoints[t].x, n = Math.floor((g - h) / n), g < f[n].min && (f[n].min = g), g > f[n].max && (f[n].max = g)), c) {
                                        var m =
                                            (q + 1 - p) * Math.max(parseFloat(a.axisY.scaleBreaks.collapsibleThreshold) || 10, 10) / 100;
                                        if ((g = "waterfall" === a.type ? k.dataPointEOs[t].cumulativeSum : k.dataPoints[t].y) && g.length)
                                            for (var w = 0; w < g.length; w++) n = Math.floor((g[w] - p) / m), g[w] < d[n].min && (d[n].min = g[w]), g[w] > d[n].max && (d[n].max = g[w]);
                ...
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length) && a.axisX.scaleBreaks && a.axisX.scaleBreaks.autoCalculate && 1 <=
                    ...
                    for (var b = a.axisX.dataInfo, c = b.min, d = b.max, f = b._dataRanges, g, h = 0, l = 0; l < a.dataSeriesIndexes.length; l++) {
                        ...
                        if (!(4 > p.dataPoints.length))
                            for (h = 0; h < p.dataPoints.length; h++) g = (d + 1 - c) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, b = p.dataPoints[h].x.getTime ? p.dataPoints[h].x.getTime() : p.dataPoints[h].x, g = Math.floor((b - c) / g), b < f[g].min && (f[g].min = b), b > f[g].max && (f[g].max = b)
                    }
            }
            for (var b, e = this, f = !1, l = 0; l <
                ...
                for (l = 0; l < this.plotInfo.plotTypes.length; l++)
                    for (f = this.plotInfo.plotTypes[l], t = 0; t < f.plotUnits.length; t++) b = f.plotUnits[t], "line" === b.type ||
                ...
                for (l = 0; l < this._axes.length; l++)
                    if (this._axes[l].dataInfo._dataRanges) {
                        ...
                        if (this._axes[l].dataInfo.dataPointYNegativeSums) {
                            ...
                            p = h;
                            for (t in q) q.hasOwnProperty(t) && !isNaN(t) && (n = -1 * q[t], r(n) || (g = Math.floor((n - A) / b), n < p[g].min && (p[g].min = n), n > p[g].max && (p[g].max = n)));
                            delete this._axes[l].dataInfo.dataPointYNegativeSums
                        }
                        for (t = 0; t < h.length - 1; t++)
                            if (p = h[t].max, isFinite(p))
                                for (; t < h.length - 1;)
                                    if (A = h[t + 1].min, isFinite(A)) {
                                        n = A - p;
                                        n > b && f.push({
                                            diff: n,
                                            start: p,
        ...
        m.prototype._mouseEventHandler = function(a) {
            ...
            if (this.interactivityEnabled)
                ...
                else if (a.preventManipulation && a.preventManipulation(), a.preventDefault && a.preventDefault(), Ia && window.console && (window.console.log(c + " --\x3e x: " + d.x + "; y:" + d.y), e && window.console.log(a.which),
            ...
            if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
                ...
                if (this.panEnabled || this.zoomEnabled) {
                    ...
                    l && (this._ignoreNextEvent = !0, this._dispatchRangeEvent("rangeChanging", "zoom"), this.stockChart && (this.stockChart.navigator && this.stockChart.navigator.enabled) && (this.stockChart._rangeEventParameter ||
                        ...
                        (this.stockChart._rangeEventParameter.type = "rangeChanged", this.stockChart.dispatchEvent("rangeChanged", this.stockChart._rangeEventParameter, this.stockChart)), l && (this.zoomEnabled && "none" === this._zoomButton.style.display) && (Ma(this._zoomButton, this._resetButton), va(this, this._zoomButton, "pan"), va(this, this._resetButton, "reset")))
                }
            }
            this.isDrag = !1;
        ...
        m.prototype._plotAreaMouseMove = function(a, d) {
            if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
                ...
                if ((!e || 2 < Math.abs(c) || !f || 2 < Math.abs(b)) && (this.panEnabled || this.zoomEnabled))
                    ...
                    this.validateRegion(b, t, e ? a : this.plotArea.x2 - this.plotArea.x1, f ? d : this.plotArea.y2 - this.plotArea.y1, "xy" !==
                        this.zoomType).isValid && (this.resetOverlayedCanvas(), this.overlaidCanvasCtx.fillStyle = "#99B2B5");
                    this.overlaidCanvasCtx.globalAlpha = 0.7;
                    this.overlaidCanvasCtx.fillRect(b, t, A, h);
        ...
        m.prototype.validateRegion = function(a, d, c, b, e) {
            ...
            for (var f = 0 <= this.zoomType.indexOf("x"),
                    l = 0 <= this.zoomType.indexOf("y"), t = !1, A = [], h = [], p = [], n = 0; n < this._axes.length; n++)("axisX" === this._axes[n].type && f || "axisY" === this._axes[n].type && l) && h.push(this._axes[n]);
            for (l = 0; l < h.length; l++) {
                ...
                if (q > g) var v = g,
                    ...
                    q = v;
                if (n.scaleBreaks)
                    for (v = 0; !f && v < n.scaleBreaks._appliedBreaks.length; v++) f = n.scaleBreaks._appliedBreaks[v].startValue <= q && n.scaleBreaks._appliedBreaks[v].endValue >= g;
                if (isFinite(n.dataInfo.minDiff))
                    if (v =
                        n.getApparentDifference(q, g, null, !0), !(f || !(this.panEnabled && n.scaleBreaks && n.scaleBreaks._appliedBreaks.length) && (n.logarithmic && v < Math.pow(n.dataInfo.minDiff, 3) || !n.logarithmic && v < 3 * Math.abs(n.dataInfo.minDiff)) || q < n.minimum || g > n.maximum)) A.push(n), p.push({
                        val1: q,
                        val2: g
                    }), t = !0;
                    else if (!e) {
        ...
        m.prototype.renderIndexLabels = function(a) {
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                var h = this._indexLabels[a],
                    ...
                    n, q, t = la("indexLabelFontColor", h.dataPoint, h.dataSeries),
                    A = la("indexLabelFontSize", h.dataPoint, h.dataSeries);
                n = la("indexLabelFontFamily", h.dataPoint, h.dataSeries);
                q = la("indexLabelFontStyle", h.dataPoint, h.dataSeries);
                var l = la("indexLabelFontWeight", h.dataPoint,
                        h.dataSeries),
                    ...
                    v = la("indexLabelLineDashType", h.dataPoint, h.dataSeries),
                    ...
                    b = 0 < m ? Math.min(10, ("normal" === this.plotInfo.axisPlacement ?
                ...
                var E = h.dataPoint.indexLabelFormatter ? h.dataPoint.indexLabelFormatter(x) : h.dataPoint.indexLabel ?
                    this.replaceKeywordsWithValue(h.dataPoint.indexLabel, h.dataPoint, h.dataSeries, null, h.indexKeyword) : h.dataSeries.indexLabelFormatter ? h.dataSeries.indexLabelFormatter(x) : h.dataSeries.indexLabel ? this.replaceKeywordsWithValue(h.dataSeries.indexLabel, h.dataPoint, h.dataSeries, null, h.indexKeyword) : null;
                if (null !== E && "" !== E) {
                    var s = la("indexLabelPlacement", h.dataPoint, h.dataSeries),
                        x = la("indexLabelOrientation", h.dataPoint, h.dataSeries),
                        C = h.direction,
                        z = h.dataSeries.axisX,
                    ...
                    if ("stackedarea100" === p) {
                        ...
                        if (h.dataPoint.x < z.viewportMinimum || h.dataPoint.x > z.viewportMaximum ||
                            Math.max.apply(null, h.dataPoint.y) < B.viewportMinimum || Math.min.apply(null, h.dataPoint.y) > B.viewportMaximum) continue
                    } else if (0 <= p.indexOf("line") || 0 <= p.indexOf("area") || 0 <= p.indexOf("bubble") || 0 <= p.indexOf("scatter")) {
                        if (h.dataPoint.x < z.viewportMinimum || h.dataPoint.x > z.viewportMaximum || h.dataPoint.y < B.viewportMinimum || h.dataPoint.y > B.viewportMaximum) continue
                    } else if (0 <= p.indexOf("column") || "waterfall" === p || "error" === p && !h.axisSwapped) {
                        if (h.dataPoint.x < z.viewportMinimum || h.dataPoint.x > z.viewportMaximum ||
                            h.bounds.y1 > c.y2 || h.bounds.y2 < c.y1) continue
                    } else if (0 <= p.indexOf("bar") || "error" === p) {
                        if (h.dataPoint.x < z.viewportMinimum || h.dataPoint.x > z.viewportMaximum || h.bounds.x1 > c.x2 || h.bounds.x2 < c.x1) continue
                    } else if ("candlestick" === p || "ohlc" === p) {
                        if (h.dataPoint.x < z.viewportMinimum || h.dataPoint.x > z.viewportMaximum || Math.max.apply(null, h.dataPoint.y) < B.viewportMinimum || Math.min.apply(null, h.dataPoint.y) > B.viewportMaximum) continue
                    } else if (h.dataPoint.x < z.viewportMinimum || h.dataPoint.x > z.viewportMaximum) continue;
                    e = l = 2;
                    "horizontal" === x ? (t = g.width, A = g.height) : (A = g.width, t = g.height);
                    if ("normal" === this.plotInfo.axisPlacement) {
                        if (0 <= p.indexOf("line") || 0 <= p.indexOf("area")) s = "auto", l = 4;
                        else if (0 <= p.indexOf("stacked")) "auto" === s && (s = "inside");
                        else if ("bubble" === p || "scatter" === p) s = "inside";
                        n = h.point.x - ("horizontal" === x ? t / 2 : 0);
                        "inside" !== s ? (e = c.y1, f = c.y2, 0 < C ? (q = h.point.y - A / 2 - l - b, q < e && (q = "auto" === s ? Math.max(h.point.y, e) + A / 2 + l + b : e + A / 2 + l + b, u = q + A > h.point.y)) : (q = h.point.y + A / 2 + l + b, q > f - A - l - b && (q = "auto" === s ? Math.min(h.point.y,
                        ...
                        0 <= p.indexOf("area") || 0 <= p.indexOf("scatter") ? (s = "auto", e = 4) : 0 <= p.indexOf("stacked") ? "auto" === s && (s = "inside") : "bubble" === p && (s = "inside"), q = h.point.y, "inside" !== s ? (l = c.x1, f = c.x2, 0 > C ? (n = h.point.x - ("horizontal" === x ? t : t / 2) - e - b, n < l && (n = "auto" === s ? Math.max(h.point.x, l) + e + b : l + e + b, u = n + t > h.point.x)) : (n = h.point.x + ("horizontal" === x ? 0 : t / 2) + e + b, n > f - t - e - b && (n = "auto" === s ? Math.min(h.point.x, f) - ("horizontal" === x ? t : t / 2) - e - b : f - t - e - b, u = n < h.point.x))) : (l = Math.max(h.bounds.x1, c.x1), Math.min(h.bounds.x2, c.x2), b = 0 <= p.indexOf("range") ||
                            "error" === p ? 0 > C ? Math.max(h.bounds.x1, c.x1) + t / 2 + e : Math.min(h.bounds.x2, c.x2) - t / 2 - e : (Math.max(h.bounds.x1, c.x1) + Math.min(h.bounds.x2, c.x2)) / 2, n = 0 > C ? Math.max(h.point.x, b) - ("horizontal" === x ? t / 2 : 0) : Math.min(h.point.x, b) - t / 2, n = Math.max(n, l));
                    "vertical" === x && (q += A / 2);
                    g.x = n;
                    g.y = q;
                    g.render(!0);
                    m && ("inside" !== s && (0 > p.indexOf("bar") && ("error" !== p || !h.axisSwapped) && h.point.x > c.x1 && h.point.x < c.x2 || !u) && (0 > p.indexOf("column") && ("error" !== p || h.axisSwapped) && h.point.y > c.y1 && h.point.y < c.y2 || !u)) && (d.lineWidth = m, d.strokeStyle =
                        k ? k : "gray", d.setLineDash && d.setLineDash(N(v, m)), d.beginPath(), d.moveTo(h.point.x, h.point.y), 0 <= p.indexOf("bar") || "error" === p && h.axisSwapped ? d.lineTo(n - (0 < h.direction ? 0 : -t) + ("vertical" === x ? -t / 2 : 0), q + ("vertical" === x ? -A / 2 : 0)) : 0 <= p.indexOf("column") || "error" === p && !h.axisSwapped ? d.lineTo(n + ("horizontal" === x ? t / 2 : 0), q + ((0 < h.direction ? A : -A) + ("vertical" === x ? -A : 0)) / 2) : d.lineTo(n + ("horizontal" === x ? t / 2 : 0), q + ((q < h.point.y ? A : -A) + ("vertical" === x ? -A : 0)) / 2), d.stroke())
                }
            }
            d = {
                source: d,
            ...
            for (a = 0; a < this._indexLabels.length; a++) h = this._indexLabels[a], g = la("indexLabelBackgroundColor", h.dataPoint, h.dataSeries), h.dataSeries.indexLabelBackgroundColor = r(g) ? w ? "transparent" : null : g;
            return d
        };
        m.prototype.renderLine = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var f = [], l, t = 0; t < a.dataSeriesIndexes.length; t++) {
                    ...
                    var v = h._colorSet,
                        k = v = h.lineColor =
                        h.options.lineColor ? h.options.lineColor : v[0];
                    c.strokeStyle = v;
                    var m = !0,
                        s = 0,
                        x, r;
                    c.beginPath();
                    if (0 < p.length) {
                        for (var C = !1, s = 0; s < p.length; s++)
                            if (x = p[s].x.getTime ? p[s].x.getTime() : p[s].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !C)))
                                if ("number" !== typeof p[s].y) 0 < s && !(h.connectNullData || C || m) && (c.stroke(), w && b.stroke()), C = !0;
                                else {
                                    x = a.axisX.convertValueToPixel(x);
                                    r = a.axisY.convertValueToPixel(p[s].y);
                                    ...
                                    m || C ? (!m && h.connectNullData ? (c.setLineDash && (h.options.nullDataLineDashType || n === h.lineDashType && h.lineDashType !== h.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(l.x, l.y), n = h.nullDataLineDashType, c.setLineDash(q)), c.lineTo(x, r), w && b.lineTo(x, r)) : (c.beginPath(), c.moveTo(x, r), w && (b.beginPath(), b.moveTo(x, r))), C = m = !1) : (c.lineTo(x, r), w && b.lineTo(x, r), 0 == s % 500 && (c.stroke(), c.beginPath(), c.moveTo(x, r), w && (b.stroke(), b.beginPath(),
                                        b.moveTo(x, r))));
                                    l = {
                                        x: x,
                                        y: r
                                    };
                                    s < p.length - 1 && (k !== (p[s].lineColor || v) || n !== (p[s].lineDashType || h.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(x, r), k = p[s].lineColor || v, c.strokeStyle = k, c.setLineDash && (p[s].lineDashType ? (n = p[s].lineDashType, c.setLineDash(N(n, h.lineThickness))) : (n = h.lineDashType, c.setLineDash(g))));
                                    if (0 < p[s].markerSize || 0 < h.markerSize) {
                                        var B = h.getMarkerProperties(s, x, r, c);
                                        f.push(B);
                                        z = Q(z);
                                        w && f.push({
                                            x: x,
                                        ...
                                        h.indexLabel || p[s].indexLabelFormatter || h.indexLabelFormatter) && this._indexLabels.push({
                                        chartType: "line",
                                        dataPoint: p[s],
                                        dataSeries: h,
                                        point: {
                                        ...
                                        direction: 0 > p[s].y === a.axisY.reversed ? 1 : -1,
                                        color: v
                                    })
                                } c.stroke();
                        w && b.stroke()
        ...
        m.prototype.renderStepLine = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var f = [], l, t = 0; t < a.dataSeriesIndexes.length; t++) {
                    ...
                    v = Q(v);
                    b.strokeStyle = v;
                    b.lineWidth = 0 < h.lineThickness ? Math.max(h.lineThickness,
                        4) : 0;
                    var v = h._colorSet,
                        k = v = h.lineColor = h.options.lineColor ? h.options.lineColor : v[0];
                    c.strokeStyle = v;
                    var m = !0,
                        s = 0,
                        x, r;
                    ...
                    if (0 < p.length) {
                        for (var C = !1, s = 0; s < p.length; s++)
                            if (x = p[s].getTime ? p[s].x.getTime() : p[s].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !C)))
                                if ("number" !== typeof p[s].y) 0 < s && !(h.connectNullData || C || m) && (c.stroke(), w && b.stroke()), C = !0;
                                else {
                                    var z = r;
                                    x = a.axisX.convertValueToPixel(x);
                                    r = a.axisY.convertValueToPixel(p[s].y);
                                    var B = h.dataPointIds[s];
                                    ...
                                    m || C ? (!m && h.connectNullData ? (c.setLineDash && (h.options.nullDataLineDashType || n === h.lineDashType && h.lineDashType !== h.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(l.x, l.y), n = h.nullDataLineDashType, c.setLineDash(q)), c.lineTo(x, z), c.lineTo(x, r), w && (b.lineTo(x, z), b.lineTo(x, r))) : (c.beginPath(), c.moveTo(x, r), w && (b.beginPath(), b.moveTo(x, r))), C = m = !1) : (c.lineTo(x, z), w && b.lineTo(x, z), c.lineTo(x,
                                        r), w && b.lineTo(x, r), 0 == s % 500 && (c.stroke(), c.beginPath(), c.moveTo(x, r), w && (b.stroke(), b.beginPath(), b.moveTo(x, r))));
                                    l = {
                                        x: x,
                                        y: r
                                    };
                                    s < p.length - 1 && (k !== (p[s].lineColor || v) || n !== (p[s].lineDashType || h.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(x, r), k = p[s].lineColor || v, c.strokeStyle = k, c.setLineDash && (p[s].lineDashType ? (n = p[s].lineDashType, c.setLineDash(N(n, h.lineThickness))) : (n = h.lineDashType, c.setLineDash(g))));
                                    if (0 < p[s].markerSize || 0 < h.markerSize) z = h.getMarkerProperties(s, x, r, c), f.push(z), B = Q(B),
                                        w && f.push({
                                            x: x,
                                            y: r,
                                            ctx: b,
                                    ...
                                    (p[s].indexLabel || h.indexLabel || p[s].indexLabelFormatter || h.indexLabelFormatter) && this._indexLabels.push({
                                        chartType: "stepLine",
                                        dataPoint: p[s],
                                        dataSeries: h,
                                        point: {
        ...
        m.prototype.renderSpline = function(a) {
            function d(a) {
                ...
                if (0 < a.length) {
                    ...
                    for (var c = 0; c < a.length - 3; c += 3)
                        if (b.bezierCurveTo(a[c + 1].x, a[c + 1].y, a[c + 2].x, a[c + 2].y, a[c + 3].x, a[c + 3].y), w && e.bezierCurveTo(a[c + 1].x, a[c + 1].y, a[c + 2].x, a[c + 2].y, a[c + 3].x, a[c + 3].y), 0 < c && 0 === c % 3E3 || a[c + 3].newStrokeStyle || a[c + 3].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(a[c + 3].x,
                            a[c + 3].y), a[c + 3].newStrokeStyle && (b.strokeStyle = a[c + 3].newStrokeStyle), a[c + 3].newLineDashArray && b.setLineDash(a[c + 3].newLineDashArray), w && (e.stroke(), e.beginPath(), e.moveTo(a[c + 3].x, a[c + 3].y));
                    b.stroke();
                    w && e.stroke()
                }
            }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var l = [], t = 0; t < a.dataSeriesIndexes.length; t++) {
                    ...
                    if (0 < p.length)
                        for (x = !1, m = 0; m < p.length; m++)
                            if (s = p[m].getTime ? p[m].x.getTime() : p[m].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !x)))
                                if ("number" !== typeof p[m].y) 0 < m && !x && (h.connectNullData ? b.setLineDash && (0 < r.length && (h.options.nullDataLineDashType || !p[m - 1].lineDashType)) && (r[r.length - 1].newLineDashArray = q, n = h.nullDataLineDashType) : (d(r), r = [])), x = !0;
                                else {
                                    s = a.axisX.convertValueToPixel(s);
                                    x = a.axisY.convertValueToPixel(p[m].y);
                                    var C = h.dataPointIds[m];
                                    ...
                                    m < p.length - 1 && (k !== (p[m].lineColor || v) || n !== (p[m].lineDashType || h.lineDashType)) && (k = p[m].lineColor || v, r[r.length - 1].newStrokeStyle = k, b.setLineDash && (p[m].lineDashType ? (n = p[m].lineDashType, r[r.length - 1].newLineDashArray = N(n, h.lineThickness)) : (n = h.lineDashType, r[r.length - 1].newLineDashArray = g)));
                                    if (0 < p[m].markerSize || 0 < h.markerSize) {
                                        var z = h.getMarkerProperties(m, s, x, b);
                                        l.push(z);
                                        C = Q(C);
                                        w && l.push({
                                            x: s,
                ...
                W.drawMarkers(l);
                w && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width,
        ...
        m.prototype.renderColumn = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null,
                    e = this.plotArea,
                    f = 0,
                    l, t, A, h = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                ...
                for (p = 0; p < a.dataSeriesIndexes.length; p++) {
                    var q = a.dataSeriesIndexes[p],
                        ...
                        v = g.dataPoints;
                    if (0 < v.length)
                        for (var k = 5 < n && g.bevelEnabled ? !0 : !1, f = 0; f < v.length; f++)
                            if (v[f].getTime ? A = v[f].x.getTime() : A = v[f].x, !(A < a.axisX.dataInfo.viewPortMin || A > a.axisX.dataInfo.viewPortMax) && "number" === typeof v[f].y) {
                                l =
                                    a.axisX.convertValueToPixel(A);
                                t = a.axisY.convertValueToPixel(v[f].y);
                                ...
                                0 <= v[f].y ? s = h : (s = t, t = h);
                                t > s && (b = t, t = s, s = b);
                                b = v[f].color ? v[f].color : g._colorSet[f % g._colorSet.length];
                                ca(c, l, t, m, s, b, 0, null, k && 0 <= v[f].y, 0 > v[f].y && k, !1, !1, g.fillOpacity);
                                b = g.dataPointIds[f];
                                this._eventManager.objectMap[b] = {
                                    id: b,
                                    objectType: "dataPoint",
                                ...
                                b = Q(b);
                                w && ca(this._eventManager.ghostCtx, l, t, m, s, b, 0, null, !1, !1, !1, !1);
                                (v[f].indexLabel || g.indexLabel || v[f].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: "column",
                                    dataPoint: v[f],
                                    dataSeries: g,
                                    point: {
                                        x: l + (m - l) / 2,
                                        y: 0 > v[f].y === a.axisY.reversed ? t : s
                                    },
                                    direction: 0 > v[f].y === a.axisY.reversed ? 1 : -1,
                                    bounds: {
                                        x1: l,
                                        y1: Math.min(t, s),
                                        x2: m,
        ...
        m.prototype.renderStackedColumn = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                !this.dataPointMaxWidth && (this.dataPointMinWidth &&
                    p < h) && (p = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, h));
                g < h && (g = h);
                g > p && (g = p);
                c.save();
                w && this._eventManager.ghostCtx.save();
                ...
                for (var v = 0; v < a.dataSeriesIndexes.length; v++) {
                    ...
                    if (0 < s.length) {
                        ...
                        for (h = 0; h < s.length; h++)
                            if (b = s[h].x.getTime ? s[h].x.getTime() : s[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof s[h].y) {
                                p = a.axisX.convertValueToPixel(b);
                                var r = p - a.plotType.plotUnits.length * g / 2 + a.index * g << 0,
                                    C = r + g << 0,
                                    z;
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < s[h].y) t[b] = s[h].y + (t[b] ? t[b] : 0), 0 < t[b] && (n = a.axisY.convertValueToPixel(t[b]), z = "undefined" !== typeof f[b] ? f[b] : q, f[b] = n);
                                else if (a.axisY.scaleBreaks &&
                                    0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= s[h].y) A[b] = s[h].y + (A[b] ? A[b] : 0), z = a.axisY.convertValueToPixel(A[b]), n = "undefined" !== typeof l[b] ? l[b] : q, l[b] = z;
                                else if (n = a.axisY.convertValueToPixel(s[h].y), 0 <= s[h].y) {
                                    var B = "undefined" !== typeof f[b] ? f[b] : 0;
                                    n -= B;
                                    z = q - B;
                                    f[b] = B + (z - n)
                                } else B = l[b] ? l[b] : 0, z = n + B, n = q + B, l[b] = B + (z - n);
                                b = s[h].color ? s[h].color : m._colorSet[h % m._colorSet.length];
                                ca(c, r, n, C, z, b, 0, null, x && 0 <= s[h].y, 0 > s[h].y && x, !1, !1, m.fillOpacity);
                                b = m.dataPointIds[h];
                                this._eventManager.objectMap[b] = {
                                    id: b,
                                    objectType: "dataPoint",
                                ...
                                b = Q(b);
                                w && ca(this._eventManager.ghostCtx, r, n, C, z, b, 0, null, !1, !1, !1, !1);
                                (s[h].indexLabel || m.indexLabel || s[h].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({
                ...
                for (var v = 0; v < a.dataSeriesIndexes.length; v++) {
                    ...
                    if (0 < s.length)
                        for (var x = 5 < g && m.bevelEnabled ? !0 : !1,
                            ...
                            if (b = s[h].x.getTime ? s[h].x.getTime() : s[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof s[h].y) {
                                p = a.axisX.convertValueToPixel(b);
                                n = 0 !== a.dataPointYSums[b] ? 100 * (s[h].y / a.dataPointYSums[b]) : 0;
                                var r = p - a.plotType.plotUnits.length * g / 2 + a.index * g << 0,
                                    C = r + g << 0,
                                    z;
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < s[h].y) {
                                    t[b] = n + ("undefined" !== typeof t[b] ? t[b] : 0);
                                    if (0 >= t[b]) continue;
                                    n = a.axisY.convertValueToPixel(t[b]);
                                    z = f[b] ? f[b] : q;
                                    f[b] = n
                                } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= s[h].y) A[b] = n + ("undefined" !== typeof A[b] ? A[b] : 0), z = a.axisY.convertValueToPixel(A[b]), n = l[b] ? l[b] : q, l[b] = z;
                                else if (n = a.axisY.convertValueToPixel(n), 0 <= s[h].y) {
                                    var B = "undefined" !== typeof f[b] ? f[b] : 0;
                                    n -= B;
                                    z = q - B;
                                    a.dataSeriesIndexes.length - 1 === v && 1 >= Math.abs(e.y1 - n) && (n = e.y1);
                                    f[b] = B + (z - n)
                                } else B = "undefined" !== typeof l[b] ? l[b] : 0, z = n + B, n = q + B, a.dataSeriesIndexes.length - 1 === v && 1 >= Math.abs(e.y2 - z) && (z = e.y2), l[b] =
                                    B + (z - n);
                                b = s[h].color ? s[h].color : m._colorSet[h % m._colorSet.length];
                                ca(c, r, n, C, z, b, 0, null, x && 0 <= s[h].y, 0 > s[h].y && x, !1, !1, m.fillOpacity);
                                b = m.dataPointIds[h];
        ...
        m.prototype.renderBar = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null,
                    e = this.plotArea,
                    f = 0,
                    l, t, A, h = a.axisY.convertValueToPixel(a.axisY.logarithmic ?
                ...
                for (p = 0; p < a.dataSeriesIndexes.length; p++) {
                    ...
                    if (0 < v.length) {
                        ...
                        for (f = 0; f < v.length; f++)
                            if (v[f].getTime ? A = v[f].x.getTime() : A = v[f].x, !(A < a.axisX.dataInfo.viewPortMin || A > a.axisX.dataInfo.viewPortMax) && "number" === typeof v[f].y) {
                                t = a.axisX.convertValueToPixel(A);
                                l = a.axisY.convertValueToPixel(v[f].y);
                                t = a.axisX.reversed ? t + a.plotType.totalDataSeries *
                                    n / 2 - (a.previousDataSeriesCount + p) * n << 0 : t - a.plotType.totalDataSeries * n / 2 + (a.previousDataSeriesCount + p) * n << 0;
                                var m = a.axisX.reversed ? t - n << 0 : t + n << 0,
                                    s;
                                0 <= v[f].y ? s = h : (s = l, l = h);
                                b = v[f].color ? v[f].color : g._colorSet[f % g._colorSet.length];
                                ca(c, s, t, l, m, b, 0, null, k, !1, !1, !1, g.fillOpacity);
                                b = g.dataPointIds[f];
                                this._eventManager.objectMap[b] = {
                                    id: b,
                                    objectType: "dataPoint",
                                ...
                                b = Q(b);
                                w && ca(this._eventManager.ghostCtx, s, t, l, m, b, 0, null, !1, !1, !1, !1);
                                (v[f].indexLabel ||
                                    g.indexLabel || v[f].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: "bar",
                                    dataPoint: v[f],
                                    dataSeries: g,
                                    point: {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var v = 0; v < a.dataSeriesIndexes.length; v++) {
                    ...
                    if (0 < s.length) {
                        ...
                        c.strokeStyle = "#4572A7 ";
                        for (h = 0; h < s.length; h++)
                            if (b = s[h].x.getTime ? s[h].x.getTime() : s[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" ===
                                typeof s[h].y) {
                                n = a.axisX.convertValueToPixel(b);
                                var r = n - a.plotType.plotUnits.length * g / 2 + a.index * g << 0,
                                    C = r + g << 0,
                                    z;
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < s[h].y) t[b] = s[h].y + (t[b] ? t[b] : 0), 0 < t[b] && (z = f[b] ? f[b] : q, f[b] = p = a.axisY.convertValueToPixel(t[b]));
                                else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= s[h].y) A[b] = s[h].y + (A[b] ? A[b] : 0), p = l[b] ? l[b] : q, l[b] = z = a.axisY.convertValueToPixel(A[b]);
                                else if (p = a.axisY.convertValueToPixel(s[h].y),
                                    0 <= s[h].y) {
                                    var B = f[b] ? f[b] : 0;
                                    z = q + B;
                                    p += B;
                                    f[b] = B + (p - z)
                                } else B = l[b] ? l[b] : 0, z = p - B, p = q - B, l[b] = B + (p - z);
                                b = s[h].color ? s[h].color : m._colorSet[h % m._colorSet.length];
                                ca(c, z, r, p, C, b, 0, null, x, !1, !1, !1, m.fillOpacity);
                                b = m.dataPointIds[h];
                                this._eventManager.objectMap[b] = {
                                    id: b,
                                    objectType: "dataPoint",
                                ...
                                b = Q(b);
                                w && ca(this._eventManager.ghostCtx, z, r, p, C, b, 0, null, !1, !1, !1, !1);
                                (s[h].indexLabel || m.indexLabel || s[h].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({
                    ...
                    if (0 < s.length) {
                        ...
                        for (h = 0; h < s.length; h++)
                            if (b = s[h].x.getTime ? s[h].x.getTime() : s[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof s[h].y) {
                                n = a.axisX.convertValueToPixel(b);
                                var r;
                                r = 0 !== a.dataPointYSums[b] ? 100 * (s[h].y / a.dataPointYSums[b]) : 0;
                                var C =
                                    n - a.plotType.plotUnits.length * g / 2 + a.index * g << 0,
                                    z = C + g << 0;
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < s[h].y) {
                                    t[b] = r + (t[b] ? t[b] : 0);
                                    if (0 >= t[b]) continue;
                                    r = f[b] ? f[b] : q;
                                    f[b] = p = a.axisY.convertValueToPixel(t[b])
                                } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= s[h].y) A[b] = r + (A[b] ? A[b] : 0), p = l[b] ? l[b] : q, l[b] = r = a.axisY.convertValueToPixel(A[b]);
                                else if (p = a.axisY.convertValueToPixel(r), 0 <= s[h].y) {
                                    var B = f[b] ? f[b] : 0;
                                    r = q + B;
                                    p += B;
                                    a.dataSeriesIndexes.length -
                                        1 === v && 1 >= Math.abs(e.x2 - p) && (p = e.x2);
                                    f[b] = B + (p - r)
                                } else B = l[b] ? l[b] : 0, r = p - B, p = q - B, a.dataSeriesIndexes.length - 1 === v && 1 >= Math.abs(e.x1 - r) && (r = e.x1), l[b] = B + (p - r);
                                b = s[h].color ? s[h].color : m._colorSet[h % m._colorSet.length];
                                ca(c, r, C, p, z, b, 0, null, x, !1, !1, !1, m.fillOpacity);
                                b = m.dataPointIds[h];
                                this._eventManager.objectMap[b] = {
                                    id: b,
                                    objectType: "dataPoint",
                                ...
                                b = Q(b);
                                w && ca(this._eventManager.ghostCtx, r, C, p, z, b, 0, null, !1, !1, !1, !1);
                                (s[h].indexLabel || m.indexLabel ||
                                    s[h].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({
        ...
        m.prototype.renderArea = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                f.clip();
                w && (l.beginPath(), l.rect(h.x1, h.y1, h.width, h.height), l.clip());
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    d = !0;
                    var k = 0,
                        m, s, r, E = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                        C, z = null;
                    if (0 < v.length) {
                        var B = g._colorSet[k % g._colorSet.length],
                            u = g.lineColor = g.options.lineColor || B,
                            y = u;
                        f.fillStyle = B;
                        f.strokeStyle = u;
                        ...
                        for (var ja = !0; k < v.length; k++)
                            if (r = v[k].x.getTime ? v[k].x.getTime() : v[k].x, !(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !ja)))
                                if ("number" !== typeof v[k].y) g.connectNullData ||
                                    (ja || d) || b(), ja = !0;
                                else {
                                    m = a.axisX.convertValueToPixel(r);
                                    s = a.axisY.convertValueToPixel(v[k].y);
                                    d || ja ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || c === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = m, c = s, m = p.x, s = p.y, b(), f.moveTo(p.x, p.y), m = d, s = c, z = p, c = g.nullDataLineDashType, f.setLineDash(S)), f.lineTo(m, s), w && l.lineTo(m, s)) : (f.beginPath(), f.moveTo(m, s), w && (l.beginPath(), l.moveTo(m, s)), z = {
                                        x: m,
                                        y: s
                                    }), ja = d = !1) : (f.lineTo(m, s), w && l.lineTo(m, s), 0 == k % 250 && b());
                                    p = {
                                        x: m,
                                        y: s
                                    };
                                    k < v.length - 1 && (y !== (v[k].lineColor || u) || c !== (v[k].lineDashType || g.lineDashType)) && (b(), y = v[k].lineColor || u, f.strokeStyle = y, f.setLineDash && (v[k].lineDashType ? (c = v[k].lineDashType, f.setLineDash(N(c, g.lineThickness))) : (c = g.lineDashType, f.setLineDash(P))));
                                    var aa = g.dataPointIds[k];
                                    ...
                                    0 !== v[k].markerSize && (0 < v[k].markerSize || 0 < g.markerSize) && (r = g.getMarkerProperties(k, m, s, f), A.push(r), aa = Q(aa),
                                        w && A.push({
                                            x: m,
                                            y: s,
                                            ctx: l,
                                    ...
                                    (v[k].indexLabel || g.indexLabel || v[k].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({
                                        chartType: "area",
                                        dataPoint: v[k],
                                        dataSeries: g,
                                        point: {
                ...
                w && (e.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), f.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && f.drawImage(a.axisX.maskCanvas,
                    0, 0, this.width, this.height), a.axisY.maskCanvas && f.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), f.clearRect(h.x1, h.y1, h.width, h.height), this._eventManager.ghostCtx.restore());
                f.restore();
                return {
                    source: e,
                    dest: this.plotArea.ctx,
        ...
        m.prototype.renderSplineArea = function(a) {
            function d() {
                ...
                if (0 < c.length) {
                    ...
                    a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? m = k : 0 > a.axisY.viewportMaximum ? m = f.y1 : 0 < a.axisY.viewportMinimum && (m = k);
                    s = {
                        x: c[0].x,
                        y: c[0].y
                    };
                    ...
                    b.fill();
                    b.globalAlpha = 1;
                    w && (e.lineTo(c[c.length - 1].x, m), e.lineTo(s.x, m), e.closePath(), e.fill())
                }
            }
            var c = a.targetCanvasCtx || this.plotArea.ctx,
                b = w ? this._preRenderCtx : c;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var A =
                    ...
                    var l = [],
                        q = 0,
                        g, v, k = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                        m, s = null,
                        r = [];
                    if (0 < n.length) {
                        var E = p._colorSet[q % p._colorSet.length],
                            C = p.lineColor = p.options.lineColor || E,
                            z = C;
                        b.fillStyle = E;
                        b.strokeStyle = C;
                        ...
                        var B = "solid";
                        if (b.setLineDash) {
                            var y = N(p.nullDataLineDashType,
                                    p.lineThickness),
                                B = p.lineDashType,
                                D = N(B, p.lineThickness);
                            b.setLineDash(D)
                        }
                        for (v = !1; q < n.length; q++)
                            if (g = n[q].x.getTime ? n[q].x.getTime() : n[q].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!p.connectNullData || !v)))
                                if ("number" !== typeof n[q].y) 0 < q && !v && (p.connectNullData ? b.setLineDash && (0 < r.length && (p.options.nullDataLineDashType || !n[q - 1].lineDashType)) && (r[r.length - 1].newLineDashArray = y, B = p.nullDataLineDashType) : (d(), r = [])), v = !0;
                                else {
                                    g = a.axisX.convertValueToPixel(g);
                                    v = a.axisY.convertValueToPixel(n[q].y);
                                    var S = p.dataPointIds[q];
                                    ...
                                    q < n.length - 1 && (z !== (n[q].lineColor || C) || B !== (n[q].lineDashType || p.lineDashType)) && (z = n[q].lineColor || C, r[r.length - 1].newStrokeStyle = z, b.setLineDash && (n[q].lineDashType ? (B = n[q].lineDashType, r[r.length - 1].newLineDashArray = N(B, p.lineThickness)) : (B = p.lineDashType, r[r.length - 1].newLineDashArray = D)));
                                    if (0 !== n[q].markerSize && (0 < n[q].markerSize || 0 < p.markerSize)) {
                                        var P =
                                            p.getMarkerProperties(q, g, v, b);
                                        l.push(P);
                                        S = Q(S);
                                        w && l.push({
                                            x: g,
        ...
        m.prototype.renderStepArea =
            function(a) {
                ...
                function b() {
                    z && (0 < g.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? C = E : 0 > a.axisY.viewportMaximum ? C = t.y1 : 0 < a.axisY.viewportMinimum && (C = E), f.lineTo(m, C), f.lineTo(z.x, C), f.closePath(), f.globalAlpha = g.fillOpacity, f.fill(), f.globalAlpha = 1, w && (l.lineTo(m, C), l.lineTo(z.x, C), l.closePath(), l.fill()), f.beginPath(), f.moveTo(m, s), l.beginPath(), l.moveTo(m, s), z = {
                        x: m,
                        y: s
                    })
                }
                ...
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    ...
                    for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                        ...
                        d = !0;
                        var k = 0,
                            m, s, r, E = a.axisY.convertValueToPixel(a.axisY.logarithmic ?
                                a.axisY.viewportMinimum : 0),
                            C, z = null;
                        c = !1;
                        if (0 < v.length) {
                            ...
                            for (; k < v.length; k++)
                                if (r = v[k].x.getTime ? v[k].x.getTime() : v[k].x, !(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !c))) {
                                    var aa = s;
                                    "number" !==
                                    typeof v[k].y ? (g.connectNullData || (c || d) || b(), c = !0) : (m = a.axisX.convertValueToPixel(r), s = a.axisY.convertValueToPixel(v[k].y), d || c ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || S === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = m, c = s, m = p.x, s = p.y, b(), f.moveTo(p.x, p.y), m = d, s = c, z = p, S = g.nullDataLineDashType, f.setLineDash(P)), f.lineTo(m, aa), f.lineTo(m, s), w && (l.lineTo(m, aa), l.lineTo(m, s))) : (f.beginPath(), f.moveTo(m, s), w && (l.beginPath(), l.moveTo(m, s)), z = {
                                            x: m,
                                            y: s
                                        }), c =
                                        d = !1) : (f.lineTo(m, aa), w && l.lineTo(m, aa), f.lineTo(m, s), w && l.lineTo(m, s), 0 == k % 250 && b()), p = {
                                        x: m,
                                        y: s
                                    }, k < v.length - 1 && (y !== (v[k].lineColor || u) || S !== (v[k].lineDashType || g.lineDashType)) && (b(), y = v[k].lineColor || u, f.strokeStyle = y, f.setLineDash && (v[k].lineDashType ? (S = v[k].lineDashType, f.setLineDash(N(S, g.lineThickness))) : (S = g.lineDashType, f.setLineDash(D)))), r = g.dataPointIds[k], this._eventManager.objectMap[r] = {
                                        id: r,
                                        objectType: "dataPoint",
                                        dataSeriesIndex: q,
                                        dataPointIndex: k,
                                        ...
                                        v[k].markerSize || 0 < g.markerSize) && (aa = g.getMarkerProperties(k, m, s, f), A.push(aa), r = Q(r), w && A.push({
                                        x: m,
                                        y: s,
                                        ctx: l,
                                        type: aa.type,
        ...
        m.prototype.renderStackedArea = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null,
                    ...
                    n = [],
                    q = 0,
                    g, k, m = a.axisY.convertValueToPixel(a.axisY.logarithmic ?
                        a.axisY.viewportMinimum : 0),
                ...
                for (var e = [], C = 0; C < a.dataSeriesIndexes.length; C++) {
                    var z = a.dataSeriesIndexes[C],
                        B = this.data[z],
                        u = B.dataPoints;
                    B.dataPointIndexes = [];
                    for (q = 0; q < u.length; q++) z = u[q].x.getTime ? u[q].x.getTime() : u[q].x, B.dataPointIndexes[z] = q, e[z] || (p.push(z), e[z] = !0);
                    p.sort(Ra)
                }
                for (C = 0; C < a.dataSeriesIndexes.length; C++) {
                    ...
                    if (0 < p.length) {
                        ...
                        if (b.setLineDash) {
                            ...
                            E = B.lineDashType;
                            var D = N(E, B.lineThickness);
                            b.setLineDash(D)
                        }
                        for (var aa = !0, q = 0; q < p.length; q++) {
                            var f = p[q],
                                fa = null,
                                fa = 0 <= B.dataPointIndexes[f] ?
                                u[B.dataPointIndexes[f]] : {
                                    x: f,
                                    y: null
                                };
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!B.connectNullData || !aa)))
                                if ("number" !== typeof fa.y) B.connectNullData || (aa || x) || d(), aa = !0;
                                    ...
                                    A[f] = m - k;
                                    x || aa ? (!x && B.connectNullData ? (b.setLineDash && (B.options.nullDataLineDashType || E === B.lineDashType && B.lineDashType !== B.nullDataLineDashType) && (x = h.pop(), E = h[h.length - 1], d(), b.moveTo(s.x, s.y), h.push(E), h.push(x), E = B.nullDataLineDashType, b.setLineDash(P)), b.lineTo(g, k), w && r.lineTo(g, k)) : (b.beginPath(), b.moveTo(g, k), w && (r.beginPath(), r.moveTo(g, k))), aa = x = !1) : (b.lineTo(g, k), w && r.lineTo(g, k), 0 == q % 250 && (d(), b.moveTo(g, k), w && r.moveTo(g, k), h.push({
                                        x: g,
                                        y: m - ma
                                    })));
                                    s = {
                                    ...
                                    q < u.length - 1 &&
                                        (S !== (u[q].lineColor || y) || E !== (u[q].lineDashType || B.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, k), h.push({
                                            x: g,
                                            y: m - ma
                                        }), S = u[q].lineColor || y, b.strokeStyle = S, b.setLineDash && (u[q].lineDashType ? (E = u[q].lineDashType, b.setLineDash(N(E, B.lineThickness))) : (E = B.lineDashType, b.setLineDash(D))));
                                    ...
                                    0 <= B.dataPointIndexes[f] &&
                                        0 !== fa.markerSize && (0 < fa.markerSize || 0 < B.markerSize) && (ma = B.getMarkerProperties(B.dataPointIndexes[f], g, k, b), l.push(ma), f = Q(F), w && l.push({
                                            x: g,
                                            y: k,
                                            ctx: r,
                                            type: ma.type,
                                    ...
                                    (fa.indexLabel || B.indexLabel || fa.indexLabelFormatter || B.indexLabelFormatter) && this._indexLabels.push({
                                        ...
                                        direction: 0 > u[q].y === a.axisY.reversed ? 1 : -1,
                                        color: e
                                    })
                                }
                        }
        ...
        m.prototype.renderStackedArea100 = function(a) {
            function d() {
                ...
                b.globalAlpha = 1;
                b.beginPath();
                w && (E.closePath(), E.fill(), E.beginPath());
                h = []
            }
            var c = a.targetCanvasCtx || this.plotArea.ctx,
                b = w ? this._preRenderCtx : c;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null,
                    ...
                    q =
                    0,
                    g, v, m, r, s, x = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                ...
                for (var e = [], u = 0; u < a.dataSeriesIndexes.length; u++) {
                    var z = a.dataSeriesIndexes[u],
                        B = this.data[z],
                        y = B.dataPoints;
                    B.dataPointIndexes = [];
                    for (q = 0; q < y.length; q++) z = y[q].x.getTime ? y[q].x.getTime() : y[q].x, B.dataPointIndexes[z] = q, e[z] || (p.push(z), e[z] = !0);
                    p.sort(Ra)
                }
                for (u = 0; u < a.dataSeriesIndexes.length; u++) {
                    z = a.dataSeriesIndexes[u];
                    B = this.data[z];
                    y = B.dataPoints;
                    r = !0;
                    e = B.id;
                    ...
                    if (0 < p.length) {
                        ...
                        for (var aa = !0, q = 0; q < p.length; q++) {
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!B.connectNullData || !aa)))
                                if ("number" !== typeof fa.y) B.connectNullData || (aa || r) || d(), aa = !0;
                                else {
                                    var ma;
                                    ...
                                    if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) {
                                        n[f] = ma + (n[f] ? n[f] :
                                            0);
                                        if (0 >= n[f] && a.axisY.logarithmic) continue;
                                        v = a.axisY.convertValueToPixel(n[f])
                                    } else v = a.axisY.convertValueToPixel(ma), v -= ba;
                                    h.push({
                                        x: g,
                                        y: x - ba
                                    });
                                    k[f] = x - v;
                                    r || aa ? (!r && B.connectNullData ? (b.setLineDash && (B.options.nullDataLineDashType || s === B.lineDashType && B.lineDashType !== B.nullDataLineDashType) && (r = h.pop(), s = h[h.length - 1], d(), b.moveTo(m.x, m.y), h.push(s), h.push(r), s = B.nullDataLineDashType, b.setLineDash(P)), b.lineTo(g, v), w && E.lineTo(g, v)) : (b.beginPath(), b.moveTo(g, v), w && (E.beginPath(), E.moveTo(g, v))),
                                        aa = r = !1) : (b.lineTo(g, v), w && E.lineTo(g, v), 0 == q % 250 && (d(), b.moveTo(g, v), w && E.moveTo(g, v), h.push({
                                        x: g,
                                        y: x - ba
                                    })));
                                    m = {
                                    ...
                                    q < y.length - 1 && (S !== (y[q].lineColor || D) || s !== (y[q].lineDashType || B.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, v), h.push({
                                        x: g,
                                        y: x - ba
                                    }), S = y[q].lineColor || D, b.strokeStyle = S, b.setLineDash && (y[q].lineDashType ? (s = y[q].lineDashType, b.setLineDash(N(s, B.lineThickness))) : (s = B.lineDashType, b.setLineDash(F))));
                                    if (0 <= B.dataPointIndexes[f]) {
                                    ...
                                    0 <= B.dataPointIndexes[f] && 0 !== fa.markerSize && (0 < fa.markerSize || 0 < B.markerSize) && (ba = B.getMarkerProperties(q, g, v, b), t.push(ba), f = Q(G), w && t.push({
                                        x: g,
                                        y: v,
                                        ctx: E,
                                        type: ba.type,
                ...
                W.drawMarkers(t);
                w && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height),
                    b.clearRect(l.x1, l.y1, l.width, l.height), E.restore());
                b.restore();
                return {
                    source: c,
                    dest: this.plotArea.ctx,
        ...
        m.prototype.renderBubble = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var t = -Infinity, k = Infinity, h = 0; h < a.dataSeriesIndexes.length; h++)
                    for (var p = a.dataSeriesIndexes[h], n = this.data[p], q = n.dataPoints, g = 0, e = 0; e < q.length; e++) f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined" === typeof q[e].z || (g = q[e].z, g > t && (t = g), g < k && (k = g));
                for (var v = 25 * Math.PI, m = Math.max(Math.pow(0.25 * Math.min(b.height, b.width) / 2, 2) * Math.PI,
                        v), h = 0; h < a.dataSeriesIndexes.length; h++)
                    if (p = a.dataSeriesIndexes[h], n = this.data[p], q = n.dataPoints, 0 < q.length)
                        for (c.strokeStyle = "#4572A7 ", e = 0; e < q.length; e++)
                            if (f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[e].y) {
                                ...
                                var g = q[e].z,
                                    r = 2 * Math.max(Math.sqrt((t === k ? m / 2 : v + (m - v) / (t - k) * (g - k)) / Math.PI) << 0, 1),
                                ...
                                r = Q(s);
                                w && W.drawMarker(f, l, this._eventManager.ghostCtx, g.type, g.size, r, r, g.borderThickness);
                        ...
                        for (var n = 0, q = 0, e = 0; e < p.length; e++)
                            if (f = p[e].getTime ? f = p[e].x.getTime() : f = p[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof p[e].y) {
                                ...
                                Math.sqrt((n - f) * (n - f) + (q - l) * (q - l)) < Math.min(g.size, 5) && p.length > Math.min(this.plotArea.width, this.plotArea.height) || (n = h.dataPointIds[e], this._eventManager.objectMap[n] = {
                                    ...
                                    x1: f,
                                    y1: l
                                }, n = Q(n), w && W.drawMarker(g.x, g.y, this._eventManager.ghostCtx, g.type, g.size, n, n, g.borderThickness), (p[e].indexLabel || h.indexLabel ||
                                    p[e].indexLabelFormatter || h.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: "scatter",
                                    dataPoint: p[e],
                                    dataSeries: h,
                                    point: {
        ...
        m.prototype.renderCandlestick = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                v = this.options.dataPointWidth ? this.dataPointWidth : 0.7 * l.width * (a.axisX.logarithmic ? Math.log(v) / Math.log(a.axisX.range) : Math.abs(v) / Math.abs(a.axisX.range)) << 0;
                ...
                for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                    var ka = a.dataSeriesIndexes[m],
                        s = this.data[ka],
                        x = s.dataPoints;
                    if (0 < x.length)
                        for (var E = 5 < v && s.bevelEnabled ? !0 : !1, t = 0; t < x.length; t++)
                            if (x[t].getTime ? g = x[t].x.getTime() : g = x[t].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !r(x[t].y) && x[t].y.length && "number" === typeof x[t].y[0] && "number" === typeof x[t].y[1] && "number" === typeof x[t].y[2] && "number" === typeof x[t].y[3]) {
                                k = a.axisX.convertValueToPixel(g);
                                h = a.axisY.convertValueToPixel(x[t].y[0]);
                                p = a.axisY.convertValueToPixel(x[t].y[1]);
                                n = a.axisY.convertValueToPixel(x[t].y[2]);
                                q = a.axisY.convertValueToPixel(x[t].y[3]);
                                var u = k - v / 2 << 0,
                                    z = u + v << 0,
                                    f = s.options.fallingColor ? s.fallingColor : s._colorSet[0],
                                    e = x[t].color ? x[t].color : s._colorSet[0],
                                    B = Math.round(Math.max(1, 0.15 * v)),
                                    y = 0 === B % 2 ? 0 : 0.5,
                                    D = s.dataPointIds[t];
                                ...
                                "candlestick" === s.type ? (c.moveTo(k - y, p), c.lineTo(k - y, Math.min(h, q)), c.stroke(), c.moveTo(k -
                                    ...
                                    c.stroke(), w && (e = Q(D), b.strokeStyle = e, b.moveTo(k - y, p), b.lineTo(k - y, n), b.stroke(), b.beginPath(), b.moveTo(k, h), b.lineTo(u, h), b.stroke(), b.beginPath(), b.moveTo(k, q), b.lineTo(z, q), b.stroke()));
                                (x[t].indexLabel || s.indexLabel || x[t].indexLabelFormatter || s.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: s.type,
                                    dataPoint: x[t],
                                    dataSeries: s,
                                    point: {
        ...
        m.prototype.renderBoxAndWhisker = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null,
                    f = this.plotArea,
                    l = 0,
                    t, k, h, p, n, q, g, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1,
                ...
                v = this.options.dataPointWidth ? this.dataPointWidth : 0.7 * f.width * (a.axisX.logarithmic ? Math.log(v) / Math.log(a.axisX.range) : Math.abs(v) / Math.abs(a.axisX.range)) << 0;
                ...
                for (var m = !1, m = !!a.axisY.reversed, u = 0; u < a.dataSeriesIndexes.length; u++) {
                    var s = a.dataSeriesIndexes[u],
                        x = this.data[s],
                        E = x.dataPoints;
                    if (0 < E.length)
                        for (var C = 5 < v && x.bevelEnabled ? !0 : !1, l = 0; l < E.length; l++)
                            if (E[l].getTime ? g = E[l].x.getTime() : g = E[l].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !r(E[l].y) && E[l].y.length && "number" === typeof E[l].y[0] && "number" === typeof E[l].y[1] && "number" === typeof E[l].y[2] &&
                                "number" === typeof E[l].y[3] && "number" === typeof E[l].y[4] && 5 === E[l].y.length) {
                                t = a.axisX.convertValueToPixel(g);
                                k = a.axisY.convertValueToPixel(E[l].y[0]);
                                h = a.axisY.convertValueToPixel(E[l].y[1]);
                                p = a.axisY.convertValueToPixel(E[l].y[2]);
                                n = a.axisY.convertValueToPixel(E[l].y[3]);
                                q = a.axisY.convertValueToPixel(E[l].y[4]);
                                var z = t - v / 2 << 0,
                                    B = t + v / 2 << 0,
                                    e = E[l].color ? E[l].color : x._colorSet[0],
                                    y = Math.round(Math.max(1, 0.15 * v)),
                                    D = 0 === y % 2 ? 0 : 0.5,
                                    S = E[l].whiskerColor ? E[l].whiskerColor : E[l].color ? x.whiskerColor ? x.whiskerColor :
                                    E[l].color : x.whiskerColor ? x.whiskerColor : e,
                                    ...
                                    aa = r(E[l].whiskerLength) ? r(x.options.whiskerLength) ? v : x.whiskerLength : E[l].whiskerLength,
                                    aa = "number" === typeof aa ? 0 >= aa ? 0 : aa >= v ? v : aa : "string" === typeof aa ? parseInt(aa) * v / 100 > v ? v : parseInt(aa) * v / 100 : v,
                                    fa = 1 === Math.round(P) % 2 ? 0.5 : 0,
                                    ma = E[l].stemColor ? E[l].stemColor : E[l].color ?
                                    x.stemColor ? x.stemColor : E[l].color : x.stemColor ? x.stemColor : e,
                                    ...
                                    T = E[l].lineDashType ?
                                    E[l].lineDashType : x.lineDashType,
                                ...
                                c.save();
                                0 < ba && (c.beginPath(), c.strokeStyle = ma, c.lineWidth = ba,
                                    c.setLineDash && c.setLineDash(N(H, ba)), c.moveTo(t - G, h), c.lineTo(t - G, k), c.stroke(), c.moveTo(t - G, n), c.lineTo(t - G, p), c.stroke());
                                c.restore();
                                b.lineWidth = Math.max(y, 4);
                                c.beginPath();
                                ca(c, z, Math.min(q, h), B, Math.max(h, q), xa, 0, e, m ? C : !1, m ? !1 : C, !1, !1, sa);
                                c.beginPath();
                                ca(c, z, Math.min(p, q), B, Math.max(q, p), R, 0, e, m ? !1 : C, m ? C : !1, !1, !1, sa);
                                c.beginPath();
                                c.lineWidth = y;
                                c.strokeStyle = e;
                                c.rect(z - D, Math.min(h, p) - D, B - z + 2 * D, Math.max(h, p) - Math.min(h, p) + 2 * D);
                                c.stroke();
                                c.save();
                                0 < M && (c.beginPath(), c.globalAlpha = 1, c.setLineDash &&
                                    c.setLineDash(N(T, M)), c.strokeStyle = J, c.lineWidth = M, c.moveTo(z, q - K), c.lineTo(B, q - K), c.stroke());
                                c.restore();
                                c.save();
                                0 < P && (c.beginPath(), c.setLineDash && c.setLineDash(N(F, P)), c.strokeStyle = S, c.lineWidth = P, c.moveTo(t - aa / 2 << 0, n - fa), c.lineTo(t + aa / 2 << 0, n - fa), c.stroke(), c.moveTo(t - aa / 2 << 0, k + fa), c.lineTo(t + aa / 2 << 0, k + fa), c.stroke());
                                c.restore();
                                w && (e = Q(O), b.strokeStyle = e, b.lineWidth = ba, 0 < ba && (b.moveTo(t - D - G, h), b.lineTo(t - D - G, Math.max(k, n)), b.stroke(), b.moveTo(t - D - G, Math.min(k, n)), b.lineTo(t - D - G, p), b.stroke()),
                                    ca(b, z, Math.max(h, p), B, Math.min(h, p), e, 0, null, !1, !1, !1, !1), 0 < P && (b.beginPath(), b.lineWidth = P, b.moveTo(t + aa / 2, n - fa), b.lineTo(t - aa / 2, n - fa), b.stroke(), b.moveTo(t + aa / 2, k + fa), b.lineTo(t - aa / 2, k + fa), b.stroke()));
                                (E[l].indexLabel || x.indexLabel || E[l].indexLabelFormatter || x.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: x.type,
                                    dataPoint: E[l],
                                    dataSeries: x,
                                    point: {
        ...
        m.prototype.renderRangeColumn = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null,
                    e = this.plotArea,
                    f = 0,
                    l, t, k, f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                ...
                for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                    var n = a.dataSeriesIndexes[p],
                        ...
                        g = q.dataPoints;
                    if (0 < g.length)
                        for (var v = 5 < h && q.bevelEnabled ? !0 : !1, f = 0; f < g.length; f++)
                            if (g[f].getTime ? k = g[f].x.getTime() : k = g[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && !r(g[f].y) && g[f].y.length && "number" ===
                                ...
                                var m = a.axisX.reversed ? b + a.plotType.totalDataSeries * h / 2 - (a.previousDataSeriesCount + p) * h << 0 : b - a.plotType.totalDataSeries * h / 2 + (a.previousDataSeriesCount + p) * h << 0,
                                    u = a.axisX.reversed ? m - h << 0 : m + h << 0,
                                ...
                                ca(c, m, l, u, t, b, 0, b, v, v, !1, !1, q.fillOpacity);
                                b = Q(s);
                                w && ca(this._eventManager.ghostCtx, m, l, u, t, b, 0, null, !1, !1, !1, !1);
        ...
        m.prototype.renderError = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null,
                    ...
                    l = this.plotArea,
                    t = 0,
                    k, h, p, n, q, g, m, Fa = a.axisX.dataInfo.minDiff;
                ...
                for (var u = 0, s = 0; s < this.data.length; s++) !this.data[s].type.match(/(bar|column)/ig) || !this.data[s].visible || this.data[s].type.match(/(stacked)/ig) && u || u++;
                for (var x =
                        0; x < a.dataSeriesIndexes.length; x++) {
                    var E = a.dataSeriesIndexes[x],
                        C = this.data[E],
                        z = C.dataPoints,
                        B = r(C._linkedSeries) ? !1 : C._linkedSeries.type.match(/(bar|column)/ig) && C._linkedSeries.visible ? !0 : !1,
                        D = 0;
                    if (B)
                        for (e = C._linkedSeries.id, s = 0; s < e; s++) !this.data[s].type.match(/(bar|column)/ig) || !this.data[s].visible || this.data[s].type.match(/(stacked)/ig) && D || (this.data[s].type.match(/(range)/ig) && (f = !0), D++);
                    e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth :
                        1;
                    t = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : b ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (B ? u : 1))) << 0 : 0.3 * this.width;
                    f && (t = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : b ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (B ? u : 1))) << 0 : 0.03 * this.width);
                    s = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * ((b ? l.height : l.width) * (a.axisX.logarithmic ? Math.log(Fa) / Math.log(a.axisX.range) :
                        Math.abs(Fa) / Math.abs(a.axisX.range)) / (B ? u : 1)) << 0;
                    ...
                    s > t && (s = t);
                    if (0 < z.length)
                        for (var F = C._colorSet, t = 0; t < z.length; t++) {
                            var e = C.lineColor = C.options.color ? C.options.color : F[0],
                                S = {
                                    color: z[t].whiskerColor ? z[t].whiskerColor : z[t].color ? C.whiskerColor ? C.whiskerColor :
                                        z[t].color : C.whiskerColor ? C.whiskerColor : e,
                                    thickness: r(z[t].whiskerThickness) ? C.whiskerThickness : z[t].whiskerThickness,
                                    dashType: z[t].whiskerDashType ? z[t].whiskerDashType : C.whiskerDashType,
                                    length: r(z[t].whiskerLength) ? r(C.options.whiskerLength) ? s : C.options.whiskerLength : z[t].whiskerLength,
                                    trimLength: r(z[t].whiskerLength) ? r(C.options.whiskerLength) ? 50 : 0 : 0
                                };
                            S.length = "number" === typeof S.length ? 0 >= S.length ? 0 : S.length >= s ? s : S.length : "string" === typeof S.length ? parseInt(S.length) * s / 100 > s ? s : parseInt(S.length) *
                                s / 100 > s : s;
                            S.thickness = "number" === typeof S.thickness ? 0 > S.thickness ? 0 : Math.round(S.thickness) : 2;
                            var P = {
                                color: z[t].stemColor ? z[t].stemColor : z[t].color ? C.stemColor ? C.stemColor : z[t].color : C.stemColor ? C.stemColor : e,
                                thickness: z[t].stemThickness ? z[t].stemThickness : C.stemThickness,
                                dashType: z[t].stemDashType ? z[t].stemDashType : C.stemDashType
                            };
                            P.thickness = "number" === typeof P.thickness ? 0 > P.thickness ? 0 : Math.round(P.thickness) : 2;
                            z[t].getTime ? m = z[t].x.getTime() : m = z[t].x;
                            if (!(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax) &&
                                !r(z[t].y) && z[t].y.length && "number" === typeof z[t].y[0] && "number" === typeof z[t].y[1]) {
                                var ja = a.axisX.convertValueToPixel(m);
                                b ? h = ja : k = ja;
                                ja = a.axisY.convertValueToPixel(z[t].y[0]);
                                b ? p = ja : q = ja;
                                ja = a.axisY.convertValueToPixel(z[t].y[1]);
                                b ? n = ja : g = ja;
                                b ? (q = a.axisX.reversed ? h + (B ? u : 1) * s / 2 - (B ? D - 1 : 0) * s << 0 : h - (B ? u : 1) * s / 2 + (B ? D - 1 : 0) * s << 0, g = a.axisX.reversed ? q - s << 0 : q + s << 0) : (p = a.axisX.reversed ? k + (B ? u : 1) * s / 2 - (B ? D - 1 : 0) * s << 0 : k - (B ? u : 1) * s / 2 + (B ? D - 1 : 0) * s << 0, n = a.axisX.reversed ? p - s << 0 : p + s << 0);
                                !b && q > g && (ja = q, q = g, g = ja);
                                b && p > n &&
                                    (ja = p, p = n, n = ja);
                                ja = C.dataPointIds[t];
                                ...
                                y(c, Math.min(p, n), Math.min(q, g), Math.max(n, p), Math.max(g, q), e, S, P, b);
                                w && y(this._eventManager.ghostCtx, p, q, n, g, e, S, P, b);
                                if (z[t].indexLabel || C.indexLabel || z[t].indexLabelFormatter || C.indexLabelFormatter) this._indexLabels.push({
                                    chartType: "error",
                                    dataPoint: z[t],
                                    dataSeries: C,
                                    indexKeyword: 0,
                                    point: {
                                        x: b ? z[t].y[1] >= z[t].y[0] ? p : n : p + (n - p) / 2,
                                        y: b ? q + (g - q) / 2 : z[t].y[1] >= z[t].y[0] ? g : q
                                    },
                                    direction: z[t].y[1] >= z[t].y[0] ? -1 : 1,
                                    bounds: {
                                        x1: b ? Math.min(p, n) : p,
                                        y1: b ? q : Math.min(q, g),
                                        x2: b ? Math.max(p, n) : n,
                                    ...
                                    indexKeyword: 1,
                                    point: {
                                        x: b ? z[t].y[1] >= z[t].y[0] ? n : p : p + (n - p) / 2,
                                        y: b ? q + (g - q) / 2 : z[t].y[1] >= z[t].y[0] ? q : g
                                    },
                                    direction: z[t].y[1] >= z[t].y[0] ? 1 : -1,
                                    bounds: {
                                        x1: b ? Math.min(p, n) : p,
        ...
        m.prototype.renderRangeBar = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null,
                    e = this.plotArea,
                    f = 0,
                    l, t, k, h, f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                    ...
                    if (0 < m.length) {
                        ...
                        for (f = 0; f < m.length; f++)
                            if (m[f].getTime ? h = m[f].x.getTime() : h = m[f].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !r(m[f].y) && m[f].y.length && "number" === typeof m[f].y[0] && "number" === typeof m[f].y[1]) {
                                ...
                                t = a.axisY.convertValueToPixel(m[f].y[1]);
                                k = a.axisX.convertValueToPixel(h);
                                k = a.axisX.reversed ? k + a.plotType.totalDataSeries * p / 2 - (a.previousDataSeriesCount +
                                    n) * p << 0 : k - a.plotType.totalDataSeries * p / 2 + (a.previousDataSeriesCount + n) * p << 0;
                                var u = a.axisX.reversed ? k - p << 0 : k + p << 0;
                                l > t && (b = l, l = t, t = b);
                                b = m[f].color ? m[f].color : g._colorSet[f % g._colorSet.length];
                                ca(c, l, k, t, u, b, 0, null, Fa, !1, !1, !1, g.fillOpacity);
                                b = g.dataPointIds[f];
                                this._eventManager.objectMap[b] = {
                                    id: b,
                                    objectType: "dataPoint",
                                ...
                                b = Q(b);
                                w && ca(this._eventManager.ghostCtx, l, k, t, u, b, 0, null, !1, !1, !1, !1);
                                if (m[f].indexLabel || g.indexLabel || m[f].indexLabelFormatter ||
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
                    ...
                    var f = [],
                        ...
                        m, r, u, s, x = null;
                    if (0 < n.length) {
                        var E = p._colorSet[g % p._colorSet.length],
                            C = p.lineColor = p.options.lineColor || E,
                            z = C;
                        b.fillStyle = E;
                        b.strokeStyle = C;
                        ...
                        var B = "solid";
                        if (b.setLineDash) {
                            var y = N(p.nullDataLineDashType, p.lineThickness),
                                B = p.lineDashType,
                                D = N(B, p.lineThickness);
                            b.setLineDash(D)
                        }
                        for (var S = !0; g < n.length; g++)
                            if (s = n[g].x.getTime ? n[g].x.getTime() : n[g].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!p.connectNullData ||
                                    !S)))
                                if (null !== n[g].y && n[g].y.length && "number" === typeof n[g].y[0] && "number" === typeof n[g].y[1]) {
                                    ...
                                    u = a.axisY.convertValueToPixel(n[g].y[1]);
                                    q || S ? (p.connectNullData && !q ? (b.setLineDash && (p.options.nullDataLineDashType || B === p.lineDashType && p.lineDashType !== p.nullDataLineDashType) && (k[k.length - 1].newLineDashArray = D, B = p.nullDataLineDashType, b.setLineDash(y)), b.lineTo(m, r), w && e.lineTo(m, r), k.push({
                                        x: m,
                                        y1: r,
                                        y2: u
                                    })) : (b.beginPath(), b.moveTo(m,
                                        r), x = {
                                        x: m,
                                        y: r
                                    }, k = [], k.push({
                                        ...
                                        y1: r,
                                        y2: u
                                    }), w && (e.beginPath(), e.moveTo(m, r))), S = q = !1) : (b.lineTo(m, r), k.push({
                                        x: m,
                                        y1: r,
                                        y2: u
                                    }), w && e.lineTo(m, r), 0 == g % 250 && d());
                                    s = p.dataPointIds[g];
                                    this._eventManager.objectMap[s] = {
                                        id: s,
                                        objectType: "dataPoint",
                                    ...
                                    g < n.length - 1 && (z !== (n[g].lineColor || C) || B !== (n[g].lineDashType || p.lineDashType)) && (d(), z = n[g].lineColor || C, k[k.length - 1].newStrokeStyle = z, b.strokeStyle = z, b.setLineDash && (n[g].lineDashType ? (B = n[g].lineDashType, k[k.length -
                                        1].newLineDashArray = N(B, p.lineThickness), b.setLineDash(k[k.length - 1].newLineDashArray)) : (B = p.lineDashType, k[k.length - 1].newLineDashArray = D, b.setLineDash(D))));
                                    if (0 !== n[g].markerSize && (0 < n[g].markerSize || 0 < p.markerSize)) {
                                        var P = p.getMarkerProperties(g, m, u, b);
                                        f.push(P);
                                        var F = Q(s);
                                        w && f.push({
                                            x: m,
        ...
        m.prototype.renderRangeSplineArea = function(a) {
            function d(a, c) {
                ...
                if (0 < d.length) {
                    ...
                    d = u(ka, 2);
                    b.lineTo(ka[ka.length - 1].x, ka[ka.length - 1].y);
                    for (f = d.length - 1; 2 < f; f -= 3) b.bezierCurveTo(d[f - 1].x, d[f - 1].y, d[f - 2].x, d[f - 2].y, d[f - 3].x, d[f - 3].y), w && e.bezierCurveTo(d[f - 1].x, d[f - 1].y, d[f - 2].x,
                        d[f - 2].y, d[f - 3].x, d[f - 3].y);
                    b.closePath();
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var k = 0; k < a.dataSeriesIndexes.length; k++) {
                    ...
                    var f = [],
                        ...
                        ka = [];
                    if (0 < p.length) {
                        var s = h._colorSet[n % h._colorSet.length],
                            x = h.lineColor = h.options.lineColor ||
                            s,
                            E = x;
                        b.fillStyle = s;
                        b.lineWidth = h.lineThickness;
                        ...
                        if (b.setLineDash) {
                            var B = N(h.nullDataLineDashType, h.lineThickness),
                                C = h.lineDashType;
                            z = N(C, h.lineThickness)
                        }
                        for (g = !1; n < p.length; n++)
                            if (q = p[n].x.getTime ? p[n].x.getTime() : p[n].x, !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !g)))
                                if (null !== p[n].y && p[n].y.length && "number" === typeof p[n].y[0] && "number" === typeof p[n].y[1]) {
                                    ...
                                    v = a.axisY.convertValueToPixel(p[n].y[1]);
                                    ...
                                    n < p.length - 1 && (E !== (p[n].lineColor || x) || C !== (p[n].lineDashType || h.lineDashType)) && (E = p[n].lineColor || x, r[r.length - 1].newStrokeStyle = E, b.setLineDash && (p[n].lineDashType ? (C = p[n].lineDashType, r[r.length - 1].newLineDashArray = N(C, h.lineThickness)) : (C = h.lineDashType, r[r.length - 1].newLineDashArray = z)));
                                    if (0 !== p[n].markerSize &&
                                        (0 < p[n].markerSize || 0 < h.markerSize)) {
                                        var D = h.getMarkerProperties(n, q, g, b);
                                        f.push(D);
                                        var S = Q(y);
                                        w && f.push({
                                            x: q,
                                        ...
                                        D = h.getMarkerProperties(n, q, v, b);
                                        f.push(D);
                                        S = Q(y);
                                        w && f.push({
                                            x: q,
                                    ...
                                    g = !1
                                } else 0 < n && !g && (h.connectNullData ? b.setLineDash && (0 < r.length && (h.options.nullDataLineDashType || !p[n - 1].lineDashType)) && (r[r.length - 1].newLineDashArray = B, C = h.nullDataLineDashType) : (d(z, x), r = [], ka = [])), g = !0;
                        d(z, x);
                        W.drawMarkers(f)
                    }
                }
        ...
        m.prototype.renderWaterfall = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = this._eventManager.ghostCtx,
                    ...
                    f = this.plotArea,
                    l = 0,
                    k, m, h, p, n = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                ...
                for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
                    var v = a.dataSeriesIndexes[g],
                        ...
                        u = r.dataPoints,
                        e = r._colorSet[0];
                    r.risingColor = r.options.risingColor ? r.options.risingColor :
                        e;
                    r.fallingColor = r.options.fallingColor ? r.options.fallingColor : "#e40a0a";
                    var s = "number" === typeof r.options.lineThickness ? Math.round(r.lineThickness) : 1,
                        x = 1 === Math.round(s) % 2 ? -0.5 : 0;
                    if (0 < u.length)
                        for (var E = 5 < q && r.bevelEnabled ? !0 : !1, C = !1, z = null, B = null, l = 0; l < u.length; l++)
                            if (u[l].getTime ? p = u[l].x.getTime() : p = u[l].x, "number" !== typeof u[l].y) {
                                if (0 < l && !C && r.connectNullData) var y = r.options.nullDataLineDashType || !u[l - 1].lineDashType ? r.nullDataLineDashType : u[l - 1].lineDashType;
                                C = !0
                            } else {
                                k = a.axisX.convertValueToPixel(p);
                                m = 0 === r.dataPointEOs[l].cumulativeSum ? n : a.axisY.convertValueToPixel(r.dataPointEOs[l].cumulativeSum);
                                h = 0 === r.dataPointEOs[l].cumulativeSumYStartValue ? n : a.axisY.convertValueToPixel(r.dataPointEOs[l].cumulativeSumYStartValue);
                                k = a.axisX.reversed ? k + a.plotType.totalDataSeries * q / 2 - (a.previousDataSeriesCount + g) * q << 0 : k - a.plotType.totalDataSeries * q / 2 + (a.previousDataSeriesCount + g) * q << 0;
                                var D = a.axisX.reversed ? k - q << 0 : k + q << 0;
                                m > h && (e = m, m = h, h = e);
                                ...
                                var S = u[l].color ? u[l].color : 0 < u[l].y ? r.risingColor : r.fallingColor;
                                ca(c, k, m, D, h, S, 0, S, E, E, !1, !1, r.fillOpacity);
                                e = Q(e);
                                w && ca(this._eventManager.ghostCtx, k, m, D, h, e, 0, null, !1, !1, !1, !1);
                                var P, S = k;
                                P = "undefined" !== typeof u[l].isIntermediateSum && !0 === u[l].isIntermediateSum || "undefined" !== typeof u[l].isCumulativeSum && !0 === u[l].isCumulativeSum ? 0 < u[l].y ? m : h : 0 < u[l].y ? h : m;
                                0 < l && z && (!C || r.connectNullData) && (C && c.setLineDash && c.setLineDash(N(y,
                                    s)), c.beginPath(), c.moveTo(z, B - x), c.lineTo(S, P - x), 0 < s && c.stroke(), w && (b.beginPath(), b.moveTo(z, B - x), b.lineTo(S, P - x), 0 < s && b.stroke()));
                                C = !1;
                                z = D;
                                B = 0 < u[l].y ? m : h;
                                S = u[l].lineDashType ? u[l].lineDashType : r.options.lineDashType ? r.options.lineDashType : "shortDash";
                                c.strokeStyle = u[l].lineColor ? u[l].lineColor : r.options.lineColor ? r.options.lineColor : "#9e9e9e";
                                c.lineWidth = s;
                                c.setLineDash && (S = N(S, s), c.setLineDash(S));
                                (u[l].indexLabel || r.indexLabel || u[l].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: "waterfall",
                                    dataPoint: u[l],
                                    dataSeries: r,
                                    point: {
                                    ...
                                    direction: 0 > u[l].y === a.axisY.reversed ? 1 : -1,
                                    bounds: {
                                        x1: k,
                                        y1: Math.min(m, h),
                                        x2: D,
        ...
        var Y = function(a, d, c, b, e, f, l, k, m) {
            if (!(0 > c)) {
        ...
        m.prototype.renderPie = function(a) {
                ...
                if (h && p) {
                    for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < p.length; e++) {
                        ...
                        var k = g[e],
                            ...
                            t = null,
                            n = m.getPercentAndTotal(h, f);
                        if (h.indexLabelFormatter || f.indexLabelFormatter) t = {
                            chart: m.options,
                            dataSeries: h,
                            dataPoint: f,
                            total: n.total,
                        ...
                        n = f.indexLabelFormatter ? f.indexLabelFormatter(t) : f.indexLabel ? m.replaceKeywordsWithValue(f.indexLabel, f, h, e) : h.indexLabelFormatter ? h.indexLabelFormatter(t) : h.indexLabel ? m.replaceKeywordsWithValue(h.indexLabel, f, h, e) : f.label ? f.label : "";
                        m._eventManager.objectMap[l] = k;
                        k.center = {
                            x: E.x,
                            y: E.y
                        };
                        ...
                        k.indexLabelLineColor = f.indexLabelLineColor ? f.indexLabelLineColor : h.options.indexLabelLineColor ? h.options.indexLabelLineColor : f.color ? f.color : h._colorSet[e % h._colorSet.length];
                        k.indexLabelLineThickness = r(f.indexLabelLineThickness) ? h.indexLabelLineThickness : f.indexLabelLineThickness;
                        k.indexLabelLineDashType = f.indexLabelLineDashType ? f.indexLabelLineDashType : h.indexLabelLineDashType;
                        k.indexLabelFontColor = f.indexLabelFontColor ? f.indexLabelFontColor :
                        ...
                        k.indexLabelFontSize = r(f.indexLabelFontSize) ? h.indexLabelFontSize : f.indexLabelFontSize;
                        k.indexLabelFontFamily = f.indexLabelFontFamily ? f.indexLabelFontFamily : h.indexLabelFontFamily;
                        k.indexLabelBackgroundColor = f.indexLabelBackgroundColor ? f.indexLabelBackgroundColor : h.options.indexLabelBackgroundColor ?
                            h.options.indexLabelBackgroundColor : h.indexLabelBackgroundColor;
                        k.indexLabelMaxWidth = f.indexLabelMaxWidth ? f.indexLabelMaxWidth : h.indexLabelMaxWidth ? h.indexLabelMaxWidth : 0.33 * q.width;
                        k.indexLabelWrap = "undefined" !== typeof f.indexLabelWrap ? f.indexLabelWrap : h.indexLabelWrap;
                        k.startAngle = 0 === e ? h.startAngle ? h.startAngle / 180 * Math.PI : 0 : g[e - 1].endAngle;
                        k.startAngle = (k.startAngle + 2 * Math.PI) % (2 * Math.PI);
                        k.endAngle = k.startAngle + 2 * Math.PI / y * Math.abs(f.y);
                        f = (k.endAngle + k.startAngle) / 2;
                        f = (f + 2 * Math.PI) % (2 * Math.PI);
                        k.midAngle = f;
                        if (k.midAngle > Math.PI / 2 - s && k.midAngle < Math.PI / 2 + s) {
                            if (0 === a || g[c].midAngle > k.midAngle) c = e;
                            a++
                        } else if (k.midAngle > 3 * Math.PI / 2 - s && k.midAngle < 3 * Math.PI / 2 + s) {
                            if (0 === b || g[d].midAngle > k.midAngle) d = e;
                            b++
                        }
                        k.hemisphere = f > Math.PI / 2 && f <= 3 * Math.PI / 2 ? "left" : "right";
                        k.indexLabelTextBlock = new ia(m.plotArea.ctx, {
                    ...
                    l = f = 0;
                    n = !1;
                    for (e = 0; e < p.length; e++) k = g[(c + e) % p.length], 1 < a && (k.midAngle > Math.PI / 2 - s && k.midAngle < Math.PI / 2 + s) && (f <= a / 2 && !n ? (k.hemisphere = "right", f++) : (k.hemisphere = "left", n = !0));
                    n = !1;
                    for (e = 0; e < p.length; e++) k = g[(d + e) % p.length], 1 < b && (k.midAngle > 3 * Math.PI / 2 - s && k.midAngle < 3 * Math.PI / 2 + s) && (l <= b / 2 && !n ? (k.hemisphere =
                        "left", l++) : (k.hemisphere = "right", n = !0))
                }
            }
            ...
            function c(a) {
                ...
                for (b = 0; b < p.length; b++) {
                    ...
                    if (d > c) {
                        ...
                        } else if (0 < Math.abs(g[b].center.x -
                                E.x) || 0 < Math.abs(g[b].center.y - E.y)) g[b].center.x = E.x + e * (1 - a), g[b].center.y = E.y + f * (1 - a), l = !0;
                        l && (e = {}, e.dataSeries = h, e.dataPoint = h.dataPoints[b], e.index = b, m.toolTip.highlightObjects([e]));
                        Y(m.plotArea.ctx, g[b].center, g[b].radius, p[b].color ? p[b].color : h._colorSet[b % h._colorSet.length], h.type, c, d, h.fillOpacity, g[b].percentInnerRadius)
                    }
                }
                a = m.plotArea.ctx;
                a.save();
                ...
                a.lineJoin = "round";
                for (b = b = 0; b < p.length; b++) c = g[b], c.indexLabelText && (c.indexLabelTextBlock.y -=
                    c.indexLabelTextBlock.height / 2, d = 0, d = "left" === c.hemisphere ? "inside" !== h.indexLabelPlacement ? -(c.indexLabelTextBlock.width + n) : -c.indexLabelTextBlock.width / 2 : "inside" !== h.indexLabelPlacement ? n : -c.indexLabelTextBlock.width / 2, c.indexLabelTextBlock.x += d, c.indexLabelTextBlock.render(!0), c.indexLabelTextBlock.x -= d, c.indexLabelTextBlock.y += c.indexLabelTextBlock.height / 2, "inside" !== c.indexLabelPlacement && 0 < c.indexLabelLineThickness && (d = c.center.x + B * Math.cos(c.midAngle), e = c.center.y + B * Math.sin(c.midAngle),
                        a.strokeStyle = c.indexLabelLineColor, a.lineWidth = c.indexLabelLineThickness, a.setLineDash && a.setLineDash(N(c.indexLabelLineDashType, c.indexLabelLineThickness)), a.beginPath(), a.moveTo(d, e), a.lineTo(c.indexLabelTextBlock.x, c.indexLabelTextBlock.y), a.lineTo(c.indexLabelTextBlock.x + ("left" === c.hemisphere ? -n : n), c.indexLabelTextBlock.y), a.stroke()), a.lineJoin = "miter");
                a.save()
            }
            ...
            function f(a, c, d) {
                ...
                if (0 <= a && a < p.length) {
                    var n = g[a];
                    if (0 > c && n.indexLabelTextBlock.y < l || 0 < c && n.indexLabelTextBlock.y > k) return 0;
                    var q = 0,
                        m = 0,
                        m = q = q = 0;
                    0 > c ? n.indexLabelTextBlock.y - n.indexLabelTextBlock.height / 2 > l && n.indexLabelTextBlock.y - n.indexLabelTextBlock.height / 2 + c < l && (c = -(l - (n.indexLabelTextBlock.y - n.indexLabelTextBlock.height / 2 + c))) : n.indexLabelTextBlock.y + n.indexLabelTextBlock.height / 2 < l && n.indexLabelTextBlock.y +
                        n.indexLabelTextBlock.height / 2 + c > k && (c = n.indexLabelTextBlock.y + n.indexLabelTextBlock.height / 2 + c - k);
                    c = n.indexLabelTextBlock.y + c;
                    l = 0;
                    l = "right" === n.hemisphere ? E.x + Math.sqrt(Math.pow(w, 2) - Math.pow(c - E.y, 2)) : E.x - Math.sqrt(Math.pow(w, 2) - Math.pow(c - E.y, 2));
                    m = E.x + B * Math.cos(n.midAngle);
                    q = E.y + B * Math.sin(n.midAngle);
                    q = Math.sqrt(Math.pow(l - m, 2) + Math.pow(c - q, 2));
                    m = Math.acos(B / w);
                    q = Math.acos((w * w + B * B - q * q) / (2 * B * w));
                    c = q < m ? c - n.indexLabelTextBlock.y : 0;
                    l = null;
                    for (k = 1; k < p.length; k++)
                        if (l = (a - k + g.length) % g.length, g[l].hemisphere !==
                            g[a].hemisphere) {
                            l = null;
                            break
                    ...
                    q = e(a);
                    k = l = 0;
                    0 > c ? (k = "right" === n.hemisphere ? m : q, h = c, null !== k && (m = -c, c = n.indexLabelTextBlock.y - n.indexLabelTextBlock.height / 2 - (g[k].indexLabelTextBlock.y + g[k].indexLabelTextBlock.height / 2), c - m < v && (l = -m, k = f(k, l, d + 1), +k.toFixed(x) >
                        +l.toFixed(x) && (h = c > v ? -(c - v) : -(m - (k - l)))))) : 0 < c && (k = "right" === n.hemisphere ? q : m, h = c, null !== k && (m = c, c = g[k].indexLabelTextBlock.y - g[k].indexLabelTextBlock.height / 2 - (n.indexLabelTextBlock.y + n.indexLabelTextBlock.height / 2), c - m < v && (l = m, k = f(k, l, d + 1), +k.toFixed(x) < +l.toFixed(x) && (h = c > v ? c - v : m - (l - k)))));
                    h && (d = n.indexLabelTextBlock.y + h, c = 0, c = "right" === n.hemisphere ? E.x + Math.sqrt(Math.pow(w, 2) - Math.pow(d - E.y, 2)) : E.x - Math.sqrt(Math.pow(w, 2) - Math.pow(d - E.y, 2)), n.midAngle > Math.PI / 2 - s && n.midAngle < Math.PI / 2 + s ? (l = (a -
                        ...
                        ("right" === a.hemisphere && c > a.indexLabelTextBlock.x) && (c = a.indexLabelTextBlock.x - 15)), n.indexLabelTextBlock.y = d, n.indexLabelTextBlock.x = c, n.indexLabelAngle = Math.atan2(n.indexLabelTextBlock.y - E.y, n.indexLabelTextBlock.x - E.x))
                }
                return h
            }
            ...
            function l() {
                ...
                for (var c = a = 0, d = 0, l = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
                    if (h.radius || !h.radius && "undefined" !== typeof h.innerRadius && null !== h.innerRadius && B - d <= D) l = !1;
                    l && (B -=
                        d);
                    d = 0;
                    if ("inside" !== h.indexLabelPlacement) {
                        ...
                        for (a = 0; a < p.length; a++) {
                            var k = g[a];
                            k.indexLabelTextBlock.x = E.x + w * Math.cos(k.midAngle);
                            k.indexLabelTextBlock.y = E.y + w * Math.sin(k.midAngle);
                            k.indexLabelAngle = k.midAngle;
                            k.radius = B;
                            k.percentInnerRadius = F
                        }
                        for (var t, r, a = 0; a < p.length; a++) {
                            var k = g[a],
                                s = e(a);
                            if (null !== s) {
                                t = g[a];
                                ...
                                var z = 0,
                                    z = b(t, r) - v;
                                if (0 > z) {
                                    for (var y = r = 0, C = 0; C < p.length; C++) C !== a && g[C].hemisphere === k.hemisphere && (g[C].indexLabelTextBlock.y < k.indexLabelTextBlock.y ? r++ : y++);
                                    r = z / (r + y || 1) * y;
                                    var y = -1 * (z - r),
                                        H = C = 0;
                                    "right" === k.hemisphere ? (C = f(a, r), y = -1 * (z - C), H = f(s, y), +H.toFixed(x) < +y.toFixed(x) && +C.toFixed(x) <= +r.toFixed(x) && f(a, -(y - H))) : (C = f(s, r), y = -1 * (z - C), H = f(a, y), +H.toFixed(x) < +y.toFixed(x) && +C.toFixed(x) <= +r.toFixed(x) && f(s, -(y - H)))
                                }
                            }
                        }
                    } else
                        for (a = 0; a < p.length; a++) k = g[a], w = "pie" === h.type ? 0.7 * B : 0.8 * B, s = E.x + w * Math.cos(k.midAngle), r = E.y + w * Math.sin(k.midAngle), k.indexLabelTextBlock.x = s, k.indexLabelTextBlock.y = r;
                    for (a = 0; a < p.length; a++)
                        if (k = g[a], s = k.indexLabelTextBlock.measureText(), 0 !== s.height &&
                            ...
                            E.x) < B && (s /= Math.abs(Math.sin(k.indexLabelAngle)), 9 < s && (s *= 0.3), s > d && (d = s)));
                                ...
                                if (null !== l) {
                                    ...
                                    if (q = 0 > z) {
                                        ...
                                        var m = t.indexLabelTextBlock.y - t.indexLabelTextBlock.height / 2,
                                            ...
                                            A = k.indexLabelTextBlock.y + k.indexLabelTextBlock.height / 2;
                                        q = t.indexLabelTextBlock.x + t.indexLabelTextBlock.width < k.indexLabelTextBlock.x - n || q > v + n || m > A + n || s < r - n ? !1 : !0
                                    }
                                    q ? (0 > a && (a = h), l !== a && (c = l, d += -z), 0 === h % Math.max(p.length /
                                        10, 3) && (f = !0)) : f = !0;
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var h = this.data[a.dataSeriesIndexes[0]],
                    ...
                    y = 0;
                a = !1;
                for (var z = 0; z < p.length; z++) y += Math.abs(p[z].y), !a && ("undefined" !== typeof p[z].indexLabel && null !== p[z].indexLabel && 0 < p[z].indexLabel.toString().length) && (a = !0), !a && ("undefined" !== typeof p[z].label && null !== p[z].label &&
                    0 < p[z].label.toString().length) && (a = !0);
                if (0 !== y) {
                    a = a || "undefined" !== typeof h.indexLabel && null !== h.indexLabel && 0 < h.indexLabel.toString().length;
                    var B = "inside" !== h.indexLabelPlacement && a ? 0.75 * Math.min(q.width, q.height) / 2 : 0.92 * Math.min(q.width, q.height) / 2;
                    h.radius && (B = Ta(h.radius, B));
                    var D = "undefined" !== typeof h.innerRadius && null !== h.innerRadius ? Ta(h.innerRadius, B) : 0.7 * B;
                    h.radius = B;
                    "doughnut" === h.type && (h.innerRadius = D);
                    var F = Math.min(D / B, (B - 1) / B);
                    ...
                    this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function(a) {
                        ...
                        for (var b = g[0].startAngle + 2 * Math.PI * a, c = 0; c < p.length; c++) {
                            var d = 0 === c ? g[c].startAngle : e,
                                e = d + (g[c].endAngle - g[c].startAngle),
                                f = !1;
                            e > b && (e = b, f = !0);
                            var l = p[c].color ? p[c].color : h._colorSet[c % h._colorSet.length];
                            e > d && Y(m.plotArea.ctx, g[c].center, g[c].radius, l, h.type, d, e, h.fillOpacity, g[c].percentInnerRadius);
                            if (f) break
                        }
                        k();
                        m.dispatchEvent("dataAnimationIterationEnd", {
        ...
        m.prototype.renderFunnel = function(a) {
            ...
            function c() {
                ...
                if (0 === g) return -1;
                for (var l = d[0] = 0, k = 0, n, p, b = b - a, l = !1, h = 0; h < x.length; h++) a = Math.abs(x[h].y) * f / g, l ? n = 0 == Number(c.toFixed(3)) ? 0 : a / c : (p = $ * $ * b * b - 4 * Math.abs($) * a, 0 > p ? (p = c, l = (b + p) * (e - k) / 2, a -= l, n = e - k, k += e - k, n += 0 == p ? 0 : a / p, k += a / p, l = !0) : (n = (Math.abs($) * b - Math.sqrt(p)) / 2, p = b - 2 * n / Math.abs($), k += n, k > e && (k -= n, p = c, l = (b + p) * (e - k) / 2, a -= l, n = e - k, k += e - k, n += a / p, k += a / p, l = !0), b =
                    p)), d.push(n);
                return d
            }
            ...
            function b() {
                if (s && x) {
                    for (var a, b, c, d, e, f, h, l, k, n, p, q, m, t, v = [], A = [], u = {
                            percent: null,
                            total: null
                        }, B = null, z = 0; z < x.length; z++) t = O[z], t = "undefined" !== typeof t.x5 ? (t.y2 + t.y4) / 2 : (t.y2 + t.y3) / 2, t = g(t).x2 + 1, v[z] = J - t - V;
                    t = 0.5 * V;
                    for (var z = 0, E = x.length - 1; z < x.length || 0 <= E; z++, E--) {
                        b = s.reversed ? x[E] : x[z];
                        a = b.color ? b.color : s.reversed ? s._colorSet[(x.length - 1 - z) % s._colorSet.length] : s._colorSet[z % s._colorSet.length];
                        c = b.indexLabelPlacement || s.indexLabelPlacement || "outside";
                        d = b.indexLabelBackgroundColor ||
                            s.indexLabelBackgroundColor || (w ? "transparent" : null);
                        e = b.indexLabelFontColor || s.indexLabelFontColor || "#979797";
                        f = r(b.indexLabelFontSize) ? s.indexLabelFontSize : b.indexLabelFontSize;
                        h = b.indexLabelFontStyle || s.indexLabelFontStyle || "normal";
                        ...
                        n = "number" === typeof b.indexLabelLineThickness ? b.indexLabelLineThickness : "number" === typeof s.indexLabelLineThickness ?
                            s.indexLabelLineThickness : 2;
                        ...
                        m = s.dataPointIds[z];
                        y._eventManager.objectMap[m] = {
                            id: m,
                            objectType: "dataPoint",
                            dataPointIndex: z,
                            dataSeriesIndex: 0,
                            funnelSection: O[s.reversed ? x.length - 1 - z : z]
                        };
                        "inside" === s.indexLabelPlacement && (v[z] = z !== ca ? s.reversed ? O[z].x2 - O[z].x1 : O[z].x3 - O[z].x4 : O[z].x3 - O[z].x6, 20 > v[z] && (v[z] = z !== ca ? s.reversed ?
                            O[z].x3 - O[z].x4 : O[z].x2 - O[z].x1 : O[z].x2 - O[z].x1, v[z] /= 2));
                        m = b.indexLabelMaxWidth ? b.indexLabelMaxWidth : s.options.indexLabelMaxWidth ? s.indexLabelMaxWidth : v[z];
                        if (m > v[z] || 0 > m) m = v[z];
                        A[z] = "inside" === s.indexLabelPlacement ? O[z].height : !1;
                        u = y.getPercentAndTotal(s, b);
                        if (s.indexLabelFormatter || b.indexLabelFormatter) B = {
                            chart: y.options,
                            dataSeries: s,
                            dataPoint: b,
                            total: u.total,
                        ...
                        b = b.indexLabelFormatter ? b.indexLabelFormatter(B) : b.indexLabel ? y.replaceKeywordsWithValue(b.indexLabel, b, s, z) : s.indexLabelFormatter ?
                            s.indexLabelFormatter(B) : s.indexLabel ? y.replaceKeywordsWithValue(s.indexLabel, b, s, z) : b.label ? b.label : "";
                        0 >= n && (n = 0);
                        1E3 > m && 1E3 - m < t && (m += 1E3 - m);
                        R.roundRect || Ba(R);
                        c = new ia(R, {
                            fontSize: f,
                            fontFamily: l,
            ...
            function e() {
                ...
                e = !1;
                c = 0;
                for (var g, h = J - Z - V / 2, h = s.options.indexLabelMaxWidth ? s.indexLabelMaxWidth > h ? h : s.indexLabelMaxWidth : h, l = I.length - 1; 0 <= l; l--) {
                    g = x[I[l].id];
                    c = I[l];
                    d = c.textBlock;
                ...
                if (e)
                    for (l = I.length - 1; 0 <= l; l--) a = O[l], I[l].textBlock.maxWidth = f[f.length - (l + 1)], I[l].textBlock.measureText(), I[l].textBlock.x =
                        J - h, c = I[l].textBlock.height < I[l].textBlock.maxHeight ? I[l].textBlock.height : I[l].textBlock.maxHeight, e = I[l].textBlock.width < I[l].textBlock.maxWidth ? I[l].textBlock.width : I[l].textBlock.maxWidth, I[l].height = c, I[l].width = e, c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2, I[l].textBlock.y = c - I[l].height / 2, s.reversed ? (I[l].textBlock.y + I[l].height > na + C && (I[l].textBlock.y = na + C - I[l].height), I[l].textBlock.y < sa - C && (I[l].textBlock.y = sa - C)) : (I[l].textBlock.y < na - C && (I[l].textBlock.y = na - C), I[l].textBlock.y +
                            I[l].height > sa + C && (I[l].textBlock.y = sa + C - I[l].height))
            }
            ...
            function f() {
                ...
                if ("inside" !== s.indexLabelPlacement)
                    for (var e = 0; e < O.length; e++) 0 == I[e].textBlock.text.length ? I[e].isDirty = !0 : (a = O[e], c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2, b = s.reversed ? "undefined" !== typeof a.x5 ? c > xa ? g(c).x2 + 1 : (a.x2 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1 : "undefined" !== typeof a.x5 ? c < xa ? g(c).x2 + 1 : (a.x4 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1, I[e].textBlock.x = b + V, I[e].textBlock.y = c - I[e].height / 2, s.reversed ? (I[e].textBlock.y + I[e].height >
                        na + C && (I[e].textBlock.y = na + C - I[e].height), I[e].textBlock.y < sa - C && (I[e].textBlock.y = sa - C)) : (I[e].textBlock.y < na - C && (I[e].textBlock.y = na - C), I[e].textBlock.y + I[e].height > sa + C && (I[e].textBlock.y = sa + C - I[e].height)));
                else
            ...
            function l() {
                ...
                function b() {
                    ...
                    for (var l, k = 1; k < h; k++) {
                        e = k * f;
                        for (var m = I.length - 1; 0 <= m; m--) !I[m].isDirty && (I[m].textBlock.y < e && I[m].textBlock.y + I[m].height > e) && (l = q(m), !(l >= I.length - 1) &&
                            I[m].textBlock.y + I[m].height + da > I[l].textBlock.y && (I[m].textBlock.y = I[m].textBlock.y + I[m].height - e > e - I[m].textBlock.y ? e + 1 : e - I[m].height - 1))
                    }
                    for (l = O.length - 1; 0 < l; l--)
                        if (!I[l].isDirty) {
                            ...
                            if (I[l].textBlock.y < I[e].textBlock.y + I[e].height) {
                                d = d || l;
                                f = l;
                                for (h = 0; I[f].textBlock.y < I[e].textBlock.y + I[e].height + da;) {
                ...
                for (var d, e, f, g, h, l, p = 1, m = 0; m < 2 * p; m++) {
                    for (var s = I.length - 1; 0 <= s && !(0 <= n(s) && n(s), f = I[s], g = f.textBlock, l = (h = q(s) < O.length ? I[q(s)] : null) ? h.textBlock : null, d = +f.height.toFixed(6), e = +g.y.toFixed(6), !f.isDirty && (h && e + d + da > +l.y.toFixed(6)) && (d = g.y + d + da - l.y, e = a(s, -d), e < d && (0 < e && (d -= e), e = a(q(s), d), e != d))); s--);
                    b()
                }
            }

            function k(a, b) {
                return (b < O.length ? I[b].textBlock.y : s.reversed ? na + C : sa + C) - (0 > a ? s.reversed ? sa - C : na - C : I[a].textBlock.y + I[a].height + da)
            }

            function m(a, b, c) {
                var d, e, g, l = [],
                    k = C,
                    n = []; - 1 !== b && (0 <= Y.indexOf(b) ? (e = Y.indexOf(b), Y.splice(e, 1)) : (Y.push(b), Y = Y.sort(function(a, b) {
                    return a - b
                })));
                if (0 === Y.length) l = ga;
                else {
                    e = C * (1 != Y.length || 0 != Y[0] && Y[0] != O.length -
                        1 ? 2 : 1) / h();
                ...
                var t = {
                    ...
                    changeSection: function(a) {
                        for (var b, c, d = 0; d < O.length; d++) b = g[d], c = O[d], b *= a, "undefined" === typeof n[d] &&
                            (n[d] = 0), 0 > n && (n *= -1), c.y1 += b - n[d], c.y2 += b - n[d], c.y3 += b - n[d], c.y4 += b - n[d], c.y5 && (c.y5 += b - n[d], c.y6 += b - n[d]), n[d] = b
                    }
                };
                a._animator.animate(0, c, function(c) {
                    ...
                    var e = {};
                    e.dataSeries = s;
                    e.dataPoint = s.reversed ? s.dataPoints[x.length - 1 - b] : s.dataPoints[b];
                    e.index = s.reversed ? x.length - 1 - b : b;
                    a.toolTip.highlightObjects([e]);
                    for (e = 0; e < O.length; e++) qa(d,
                        O[e], s.fillOpacity);
                    u(d);
                    H && ("inside" !== s.indexLabelPlacement ? p(d) : f(), v(d));
                    1 <= c && (ha = !1)
            ...
            function p(a) {
                for (var b, c, d, e, f = 0; f < O.length; f++) e = 1 === I[f].lineThickness % 2 ? 0.5 : 0, c = ((O[f].y2 + O[f].y4) / 2 << 0) + e, b = g(c).x2 - 1, d = I[f].textBlock.x, e = (I[f].textBlock.y + I[f].height / 2 << 0) + e, I[f].isDirty || 0 == I[f].lineThickness || (a.strokeStyle = I[f].lineColor, a.lineWidth = I[f].lineThickness, a.setLineDash &&
                    a.setLineDash(N(I[f].lineDashType, I[f].lineThickness)), a.beginPath(), a.moveTo(b, c), a.lineTo(d, e), a.stroke())
            }
            ...
            function v(a) {
                for (var b =
                        0; b < O.length; b++) I[b].isDirty || (a && (I[b].textBlock.ctx = a), I[b].textBlock.render(!0))
            }
            ...
            function u(a) {
                ...
                y.legend && (y.legend.dockInsidePlotArea ||
                    "center" === y.legend.horizontalAlign && "center" === y.legend.verticalAlign) && (y.legend.ctx = a, y.legend.setLayout(), y.legend.render());
                T.fNg && T.fNg(y)
            }
            var y = this;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                for (var s = this.data[a.dataSeriesIndexes[0]], x = s.dataPoints, E = this.plotArea, C = 0.025 * E.width, z = 0.01 * E.width, B = 0, D = E.height - 2 * C, F = Math.min(E.width - 2 * z, 2.8 * E.height), H = !1, P = 0; P < x.length; P++)
                    if (!H && ("undefined" !== typeof x[P].indexLabel && null !== x[P].indexLabel && 0 < x[P].indexLabel.toString().length) && (H = !0), !H && ("undefined" !==
                            typeof x[P].label && null !== x[P].label && 0 < x[P].label.toString().length) && (H = !0), !H && "function" === typeof s.indexLabelFormatter || "function" === typeof x[P].indexLabelFormatter) H = !0;
                H = H || "undefined" !== typeof s.indexLabel && null !== s.indexLabel && 0 < s.indexLabel.toString().length;
                "inside" !== s.indexLabelPlacement && H || (z = (E.width - 0.75 * F) / 2);
                var P = E.x1 + z,
                    J = E.x2 - z,
                    M = E.y1 + C,
                    Q = E.y2 - C,
                ...
                if (0 != s.length && (s.dataPoints && s.visible) && 0 !== x.length) {
                    ...
                    var V =
                        30 * (J - a) / 100;
                    "funnel" === s.type ? (ba = r(s.options.neckHeight) ? 0.35 * D : s.neckHeight, G = r(s.options.neckWidth) ? 0.25 * a : s.neckWidth, "string" === typeof ba && ba.match(/%$/) ? (ba = parseInt(ba), ba = ba * D / 100) : ba = parseInt(ba), "string" === typeof G && G.match(/%$/) ? (G = parseInt(G), G = G * a / 100) : G = parseInt(G), ba > D ? ba = D : 0 >= ba && (ba = 0), G > a ? G = a - 0.5 : 0 >= G && (G = 0)) : "pyramid" === s.type && (G = ba = 0, s.reversed = s.reversed ? !1 : !0);
                    var z = P + a / 2,
                        X = P,
                        Z = P + a,
                        na = s.reversed ? Q : M,
                    ...
                    var z = [],
                        ...
                        ca, $ = (xa - na) / (K - X),
                        ea = -$,
                        P = "area" === (s.valueRepresents ? s.valueRepresents : "height") ? c() : d();
                    if (-1 !== P) {
                        if (s.reversed)
                        ...
                        if (s.reversed)
                            for (G = 0; G < P.length; G++) F[G] < xa ? (a.push(K), z.push(W), ca = G) : (a.push((F[G] - na + $ * X) / $), z.push((F[G] - na + ea * Z) / ea));
                        else
                            for (G = 0; G < P.length; G++) F[G] < xa ? (a.push((F[G] - na + $ * X) / $), z.push((F[G] - na + ea * Z) / ea), ca = G) : (a.push(K), z.push(W));
                        for (G = 0; G < P.length - 1; G++) U = s.reversed ?
                            x[x.length - 1 - G].color ? x[x.length - 1 - G].color : s._colorSet[(x.length - 1 - G) % s._colorSet.length] : x[G].color ? x[G].color : s._colorSet[G % s._colorSet.length], G === ca ? O.push({
                                x1: a[G],
                                y1: F[G],
                                x2: z[G],
                                y2: F[G],
                        ...
                        a = a = 0;
                        Ca(Y);
                        for (G = 0; G < x.length; G++) x[G].exploded && (P = !0, s.reversed ?
                            Y.push(x.length - 1 - G) : Y.push(G));
                        R.clearRect(E.x1, E.y1, E.width, E.height);
                        R.fillStyle = y.backgroundColor;
                        R.fillRect(E.x1, E.y1, E.width, E.height);
                        if (H && s.visible && (b(), f(), e(), "inside" !== s.indexLabelPlacement)) {
                            l();
                            for (G = 0; G < x.length; G++) I[G].isDirty || (a = I[G].textBlock.x + I[G].width, a = (J - a) / 2, 0 == G && (B = a), B > a && (B = a));
                            for (G = 0; G < O.length; G++) O[G].x1 += B, O[G].x2 += B, O[G].x3 += B, O[G].x4 += B, O[G].x5 && (O[G].x5 += B, O[G].x6 += B), I[G].textBlock.x += B
                        }
                        for (G = 0; G < O.length; G++) B = O[G], qa(R, B, s.fillOpacity), ga.push(B.y1);
                        u(R);
                        H && s.visible && ("inside" === s.indexLabelPlacement || y.animationEnabled || p(R), y.animationEnabled || v());
                        if (!H)
                            for (G = 0; G < x.length; G++) B = s.dataPointIds[G], a = {
                                id: B,
                                objectType: "dataPoint",
                                dataPointIndex: G,
                                dataSeriesIndex: 0,
                                funnelSection: O[s.reversed ? x.length - 1 - G : G]
                        ...
                        this.funnelPyramidClickHandler = function(a) {
                            var b = -1;
                            if (!ha && !y.isAnimating && (r(a.dataSeries.explodeOnClick) || a.dataSeries.explodeOnClick) &&
                                (b = s.reversed ? x.length - 1 - a.dataPointIndex : a.dataPointIndex, 0 <= b)) {
                                a = b;
                                if ("funnel" === s.type || "pyramid" === s.type) s.reversed ? x[x.length - 1 - a].exploded = x[x.length - 1 - a].exploded ? !1 : !0 : x[a].exploded = x[a].exploded ? !1 : !0;
                                m(y, b, 500)
                            }
                        };
                        return {
                            ...
                            animationCallback: function(a, b) {
                                ...
                                1 <= a && (m(y, -1, 500), u(y.plotArea.ctx || y.ctx))
                            },
                            easingFunction: L.easing.easeInQuad,
                            animationBase: 0
                        }
        ...
        m.prototype.exportChart = function(a) {
            ...
            if (b && d && c) {
                ...
                if ("undefined" !== typeof Blob && new Blob) {
                    for (var l = b.replace(/^data:[a-z\/]*;base64,/, ""), l = atob(l), k = new ArrayBuffer(l.length), k = new Uint8Array(k), m = 0; m < l.length; m++) k[m] =
                        l.charCodeAt(m);
                    d = new Blob([k.buffer], {
                        type: "image/" + d
                    });
        ...
        m.prototype.getPercentAndTotal = function(a, d) {
            ...
            if (0 <= a.type.indexOf("stacked")) b = 0, c = d.x.getTime ? d.x.getTime() : d.x, c in a.plotUnit.yTotals && (b = a.plotUnit.yTotals[c], c = a.plotUnit.yAbsTotals[c], e = isNaN(d.y) ? 0 : 0 === c ? 0 : 100 * (d.y / c));
                ...
                for (c = b = 0; c <
                    a.dataPoints.length; c++) isNaN(a.dataPoints[c].y) || (b += a.dataPoints[c].y);
        ...
        m.prototype.replaceKeywordsWithValue = function(a, d, c, b, e) {
            ...
            if ((0 <= c.type.indexOf("stacked") || "pie" === c.type || "doughnut" === c.type || "funnel" === c.type || "pyramid" === c.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
                ...
                do {
                    ...
                    a = a.replace("#total", ea(k, c.yValueFormatString ? c.yValueFormatString : "#,##0.########", f._cultureInfo))
                } while (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))
            }
            return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function(a) {
                if ('"' === a[0] && '"' === a[a.length -
                        1] || "'" === a[0] && "'" === a[a.length - 1]) return a.slice(1, a.length - 1);
                ...
                if ("x" === a)
                    ...
                    } else return ea(g, d.xValueFormatString ? d.xValueFormatString : c.xValueFormatString ? c.xValueFormatString : c.xValueFormatString = "#,##0.########",
                        f._cultureInfo);
        ...
        F.prototype.setLayout = function() {
            var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart,
                ...
                l = 0,
                k = this.markerMargin =
                this.chart.options.legend && !r(this.chart.options.legend.markerMargin) ? this.chart.options.legend.markerMargin : 0.3 * this.fontSize;
            this.height = 0;
            var m = [],
                h = [];
            "top" === this.verticalAlign || "bottom" === this.verticalAlign ? (this.orientation = "horizontal", c = this.verticalAlign, f = this.maxWidth = null !== this.maxWidth ? this.maxWidth : d.width, l = this.maxHeight = null !== this.maxHeight ? this.maxHeight : 0.5 * d.height) : "center" === this.verticalAlign && (this.orientation = "vertical", c = this.horizontalAlign, f = this.maxWidth = null !== this.maxWidth ?
                this.maxWidth : 0.5 * d.width, l = this.maxHeight = null !== this.maxHeight ? this.maxHeight : d.height);
            ...
            for (var p = 0; p < this.dataSeries.length; p++) {
                ...
                if (n.dataPoints && n.dataPoints.length)
                    if ("pie" !== n.type && "doughnut" !== n.type && "funnel" !== n.type && "pyramid" !== n.type) {
                        var q = n.legendMarkerType = n.legendMarkerType ? n.legendMarkerType : "line" !== n.type && "stepLine" !== n.type && "spline" !== n.type && "scatter" !== n.type && "bubble" !== n.type || !n.markerType ? "error" === n.type && n._linkedSeries ?
                            n._linkedSeries.legendMarkerType ? n._linkedSeries.legendMarkerType : H.getDefaultLegendMarker(n._linkedSeries.type) : H.getDefaultLegendMarker(n.type) : n.markerType,
                            ...
                            v = n.legendMarkerColor = n.legendMarkerColor ? n.legendMarkerColor : n.markerColor ? n.markerColor : "error" === n.type ? r(n.whiskerColor) ? n._colorSet[0] : n.whiskerColor : n._colorSet[0],
                            w = n.markerSize || "line" !==
                            n.type && "stepLine" !== n.type && "spline" !== n.type ? 0.75 * this.lineHeight : 0,
                            u = n.legendMarkerBorderColor ? n.legendMarkerBorderColor : n.markerBorderColor,
                            s = n.legendMarkerBorderThickness ? n.legendMarkerBorderThickness : n.markerBorderThickness ? Math.max(1, Math.round(0.2 * w)) : 0;
                        ...
                        for (var x = 0; x < n.dataPoints.length; x++) {
                            var y = n.dataPoints[x],
                                q = y.legendMarkerType ? y.legendMarkerType : n.legendMarkerType ? n.legendMarkerType : H.getDefaultLegendMarker(n.type),
                                g = y.legendText ? y.legendText : n.legendText ? n.legendText : this.itemTextFormatter ? this.itemTextFormatter({
                                    chart: this.chart,
                                    legend: this.options,
                                    dataSeries: n,
                                    dataPoint: y
                                }) : y.name ? y.name : "DataPoint: " + (x + 1),
                                v = y.legendMarkerColor ? y.legendMarkerColor : n.legendMarkerColor ?
                                n.legendMarkerColor : y.color ? y.color : n.color ? n.color : n._colorSet[x % n._colorSet.length],
                                w = 0.75 * this.lineHeight,
                                u = y.legendMarkerBorderColor ? y.legendMarkerBorderColor : n.legendMarkerBorderColor ? n.legendMarkerBorderColor : y.markerBorderColor ? y.markerBorderColor : n.markerBorderColor,
                                s = y.legendMarkerBorderThickness ? y.legendMarkerBorderThickness : n.legendMarkerBorderThickness ? n.legendMarkerBorderThickness : y.markerBorderThickness || n.markerBorderThickness ? Math.max(1, Math.round(0.2 * w)) : 0,
                            ...
                            (y.showInLegend || n.showInLegend && !1 !== y.showInLegend) && m.push(q)
                        }
            ...
            if (0 < m.length) {
                ...
                for (p = 0; p < m.length; p++) {
                    ...
                    if (!(0 >= l || "undefined" === typeof l || 0 >= u || "undefined" === typeof u)) {
                        if ("horizontal" === this.orientation) {
                            ...
                            if (!n || n.width + Math.round(q.textBlock.width + w + k + (0 === n.width ? 0 : this.horizontalSpacing) + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0)) > f) n = {
                                items: [],
                                width: 0
                            ...
                            new ia(this.ctx, {
                                ...
                                fontStyle: this.fontStyle,
                                textBaseline: "middle"
                            }), q.textBlock.measureText(), null !== this.itemWidth && (q.textBlock.width = this.itemWidth - (w + k + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0))), this.height < l - this.lineHeight ? (n = {
                                items: [],
                                width: 0
                            }, h.push(n)) : (n = h[x], x = (x + 1) % h.length), this.height += q.textBlock.height;
                        q.textBlock.x = n.width;
                        q.textBlock.y = 0;
                        n.width += Math.round(q.textBlock.width + w + k + (0 === n.width ? 0 : this.horizontalSpacing) + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0));
                        n.items.push(q);
                        this.width = Math.max(n.width, this.width);
                        v = q.textBlock.width + (w + k + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0))
                    }
                }
                this.itemWidth = v;
        ...
        F.prototype.render = function() {
            ...
            for (var k = 0, m = 0; m < l.length; m++) {
                for (var h = l[m], p = 0, n = 0; n < h.items.length; n++) {
                    ...
                    this.ctx.clip();
                    if ("line" === q.chartType || "stepLine" === q.chartType || "spline" === q.chartType) this.ctx.strokeStyle = q.lineColor, this.ctx.lineWidth = Math.ceil(this.lineHeight / 8), this.ctx.beginPath(), this.ctx.moveTo(g - 0.1 * this.lineHeight, r + this.lineHeight / 2), this.ctx.lineTo(g + 0.85 * this.lineHeight, r + this.lineHeight / 2), this.ctx.stroke(), w -=
                        0.1 * this.lineHeight;
                    if ("error" === q.chartType) {
                        ...
                        var u = g - 0.08 * this.lineHeight + 0.1 * this.lineHeight,
                            ...
                            y = x + 0.02 * this.lineHeight;
                        this.ctx.moveTo(u, s);
                        this.ctx.lineTo(u + x, s);
                        this.ctx.stroke();
                        this.ctx.beginPath();
                        this.ctx.moveTo(u + x / 2, s);
                        this.ctx.lineTo(u + x / 2, s + y);
                        this.ctx.stroke();
                        this.ctx.beginPath();
                        this.ctx.moveTo(u, s + y);
                        this.ctx.lineTo(u + x, s + y);
                        this.ctx.stroke();
                    ...
                    if (q) {
                        switch (this.type) {
                            ...
                            case "doughnut":
                                ...
                                r < q.radius && r > u && (r = Math.atan2(d - w.y, a - w.x), 0 > r && (r += 2 * Math.PI), r = Number(((180 * (r / Math.PI) % 360 + 360) % 360).toFixed(12)), w = Number(((180 * (q.startAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), u = Number(((180 * (q.endAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), 0 === u && 1 < q.endAngle && (u = 360), w >= u && 0 !== g.y && (u += 360, r < w && (r += 360)), r > w && r < u && (b.push({
                                    dataPoint: g,
                                    dataPointIndex: f,
                                    dataSeries: this,
                                    distance: 0
        ...
        D.prototype.createLabels = function() {
            ...
            if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
                ...
                if (this.logarithmic && !this.equidistantInterval)
                    for (this.logLabelValues || (this.logLabelValues = [], this.createExtraLabelsForLog()), b = 0, g = q; b < this.logLabelValues.length; b++)
                        if (c =
                            ...
                            }) : "axisX" === this.type && this.labels[p] ? this.labels[p] : ea(p, this.valueFormatString, this.chart._cultureInfo), a = new ia(this.ctx, {
                                x: 0,
                                y: 0,
                                maxWidth: f,
                                maxHeight: l,
                ...
                for (this.intervalStartPosition =
                    ...
                    a || (a = this.labelFormatter ? this.labelFormatter({
                        ...
                        this.labels[p] : Aa(p, this.valueFormatString, this.chart._cultureInfo), a = new ia(this.ctx, {
                            x: 0,
                            y: 0,
                            maxWidth: f,
                            backgroundColor: this.labelBackgroundColor,
                    ...
                    if (f = 0.9 * k >> 0, q = 0, !this.chart.panEnabled && 1 <= this._labels.length) {
                        ...
                        for (c = 0; c < this._labels.length; c++)
                            if (!this._labels[c].breaksLabelType) {
                                ...
                                for (var u, g = a.text.split(" "), b = 0; b < g.length; b++) p = g[b], this.ctx.font = a.fontStyle + " " +
                                    a.fontWeight + " " + a.fontSize + "px " + a.fontFamily, p = this.ctx.measureText(p), p.width > q && (u = c, q = p.width)
                            } c = 0;
                                ...
                                if (r(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle)
                                    if (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? l : Math.min((b - f * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), b), p = (h - (m + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(-25))) / Math.sin(Math.PI /
                                        ...
                                        if (r(this.options.labelWrap))
                                            ...
                                            if (b = v.width + d.width >> 0, g = this.labelFontSize, q < f) b - 2 * f > n && (n = b - 2 * f, b >= 2 * f && b < 2.2 * f ? (this.sessionVariables.labelMaxWidth = f, r(this.options.labelFontSize) && 12 < g && (g = Math.floor(12 / 13 * g), a.measureText()), this.sessionVariables.labelFontSize = r(this.options.labelFontSize) ?
                                            ...
                                            else if (u === c && (0 === u && q + this._labels[u + 1].textBlock.measureText().width - 2 * f > n || u === this._labels.length - 1 && q + this._labels[u - 1].textBlock.measureText().width - 2 * f > n || 0 < u && u < this._labels.length - 1 && q + this._labels[u + 1].textBlock.measureText().width - 2 * f > n &&
            ...
            for (c = 0; c < this.stripLines.length; c++) {
                ...
                if ("outside" === f.labelPlacement) {
                    ...
                    if ("bottom" === this._position || "top" === this._position) r(f.options.labelWrap) && !r(this.sessionVariables.stripLineLabelMaxHeight) ? y = this.sessionVariables.stripLineLabelMaxHeight : this.sessionVariables.stripLineLabelMaxHeight = y = f.labelWrap ? 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize;
                    if ("left" === this._position || "right" === this._position) r(f.options.labelWrap) && !r(this.sessionVariables.stripLineLabelMaxHeight) ? y = this.sessionVariables.stripLineLabelMaxHeight : this.sessionVariables.stripLineLabelMaxHeight = y = f.labelWrap ? 0.8 * this.chart.width >> 0 : 1.5 * this.labelFontSize;
                    r(f.labelBackgroundColor) && (f.labelBackgroundColor = "#EEEEEE")
                } else l = "bottom" === this._position || "top" === this._position ? 0.9 * this.chart.width >> 0 : 0.9 * this.chart.height >> 0, y = r(f.options.labelWrap) || f.labelWrap ? "bottom" === this._position ||
        ...
        D.setLayout = function(a, d, c, b, e, f) {
            ...
            for (g = 0; g < q.length; g++)
                if (q[g] && q[g].scaleBreaks &&
                    ...
                    for (var v = q[g].scaleBreaks._appliedBreaks, w = 0; w < v.length && !(v[w].startValue > q[g].viewportMaximum); w++) v[w].endValue < q[g].viewportMinimum || (r(q[g].scaleBreaks.firstBreakIndex) && (q[g].scaleBreaks.firstBreakIndex = w), v[w].startValue >= q[g].viewPortMinimum && (q[g].scaleBreaks.lastBreakIndex = w));
            for (var u = w = 0, s = 0, x = 0, y = 0, C = 0, z = 0, B, D, F = k = 0, H, J, L, v = H = J = L = !1, g = 0; g < q.length; g++) q[g] && q[g].title && (q[g]._titleTextBlock = new ia(q[g].ctx, {
                text: q[g].title,
                horizontalAlign: "center",
            ...
            if ("normal" === e) {
                for (var x = [], y = [], C = [], z = [], M = [], N = [], Q = [], R = []; 4 >
                    ...
                    var G = 0,
                        ...
                        $ = 0;
                    if (c && 0 < c.length)
                        for (C = [], g = O = 0; g < c.length; g++) C.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateWidth() : 0)), O += C[g], K += c[g] && !p.isNavigator ? c[g].margin : 0;
                    else C.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateWidth() : 0));
                    Q.push(C);
                    if (b && 0 < b.length)
                        for (z = [], g = $ = 0; g < b.length; g++) z.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateWidth() : 0)), $ += z[g], Z += b[g] ? b[g].margin : 0;
                    else z.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateWidth() : 0));
                    R.push(z);
                    l = Math.round(f.x1 + O + K);
                    m = Math.round(f.x2 - $ - Z > p.width - n ? p.width - n : f.x2 - $ - Z);
                    if (a && 0 < a.length)
                    ...
                    if (a && 0 < a.length)
                        for (g =
                            ...
                            k, a[g].lineCoordinates.y2 = k + a[g].lineThickness / 2, "inside" === a[g].labelPlacement && 0 < g && (a[g].lineCoordinates.y1 = a[g].lineCoordinates.y1 + x[g] - (a[g]._titleTextBlock ? a[g]._titleTextBlock.height : 0) - ("inside" === a[g].tickPlacement ? a[g].tickLength : 0), a[g].lineCoordinates.y2 = a[g].lineCoordinates.y1 + a[g].lineThickness / 2), a[g].bounds = {
                                x1: l,
                                y1: k,
                                x2: m,
                                y2: h - (U + e - x[g] - G),
                    ...
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++) K = p.isNavigator ? 0 : 10, c[g] && (l = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), K = c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[c[g]._labels.length - 1].textBlock.height / 2 : n, k = Math.round(f.y1 + W + X < Math.max(K, n) ? Math.max(K, n) : f.y1 + W + X), m = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), K = 0 < a.length ? 0 : c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[0].textBlock.height /
                            2 : n, h = Math.round(f.y2 - U - e - K), c[g].lineCoordinates = {
                                x1: l - V,
                                y1: k,
                                x2: m - V,
                                y2: h,
                                height: Math.abs(h - k)
                            }, "inside" === c[g].labelPlacement && 0 < g && (c[g].lineCoordinates.x1 = c[g].lineCoordinates.x1 - (C[g] - c[g]._titleTextBlock ? c[g]._titleTextBlock.height : 0) + ("outside" === c[g].tickPlacement ? c[g].tickLength : 0), c[g].lineCoordinates.x2 = c[g].lineCoordinates.x1 + c[g].lineThickness / 2), c[g].bounds = {
                                x1: l - (C[g] + V),
                                y1: k,
                                x2: m,
                                y2: h,
                                ...
                                c[g].lineCoordinates.height ? c[g].titleMaxWidth : c[g].lineCoordinates.height), V += C[g] + c[g].margin);
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++) b[g] && (l = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2), m = Math.round(l), K = b[g]._labels && 0 < b[g]._labels.length ? b[g]._labels[b[g]._labels.length - 1].textBlock.height / 2 : 0, k = Math.round(f.y1 + W + X < Math.max(K, n) ? Math.max(K, n) : f.y1 + W + X), K = 0 < a.length ? 0 : b[g]._labels && 0 < b[g]._labels.length ? b[g]._labels[0].textBlock.height / 2 : 0, h = Math.round(f.y2 - (U + e + K)), b[g].lineCoordinates = {
                            x1: l + Y,
                            y1: k,
                            x2: l + Y,
                            y2: h,
                            height: Math.abs(h - k)
                        }, "inside" === b[g].labelPlacement && 0 < g && (b[g].lineCoordinates.x1 = b[g].lineCoordinates.x1 + (z[g] - b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0) - ("outside" === b[g].tickPlacement ? b[g].tickLength : 0) - 2, b[g].lineCoordinates.x2 = b[g].lineCoordinates.x1 + b[g].lineThickness / 2), b[g].bounds = {
                            x1: l,
                            y1: k,
                            x2: m + (z[g] + Y),
                            y2: h,
                            ...
                            b[g].lineCoordinates.height), Y += z[g] + b[g].margin);
                    if (a && 0 < a.length)
                    ...
                    if (0 < w) {
                        if (a && 0 < a.length)
                            for (g = 0; g < a.length; g++) v = M[w - 1][g] === M[w][g] ? !0 : !1;
                        else v = !0;
                        if (d && 0 < d.length)
                            for (g = 0; g < d.length; g++) H = N[w - 1][g] === N[w][g] ? !0 : !1;
                        else H = !0;
                        if (c && 0 < c.length)
                            for (g = 0; g < c.length; g++) J = Q[w - 1][g] === Q[w][g] ? !0 : !1;
                        else J = !0;
                        if (b && 0 < b.length)
                            for (g = 0; g < b.length; g++) L = R[w -
                                1][g] === R[w][g] ? !0 : !1;
                        else L = !0
                    }
                    if (v && H && J && L) break;
                ...
                for (N = []; 4 > w;) {
                    ...
                    if (a && 0 < a.length)
                        for (F = [], g = Y = 0; g < a.length; g++) F.push(Math.ceil(a[g] ? a[g].createLabelsAndCalculateWidth() : 0)), Y += F[g], e += a[g] && !p.isNavigator ? a[g].margin : 0;
                    else F.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateWidth() : 0));
                    M.push(F);
                    if (d && 0 < d.length)
                        for (u = [], g = U = 0; g < d.length; g++) u.push(Math.ceil(d[g] ? d[g].createLabelsAndCalculateWidth() : 0)), U += u[g], X += d[g] ? d[g].margin : 0;
                    else u.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateWidth() :
                        0));
                    N.push(u);
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++) c[g].lineCoordinates = {}, l = Math.round(f.x1 + Y + e), m = Math.round(f.x2 - U - X > p.width - 10 ? p.width - 10 : f.x2 - U - X), c[g].labelAutoFit && !r(x) && (0 < !a.length && (l = 0 > c[g].labelAngle ? Math.max(l, x) : 0 === c[g].labelAngle ? Math.max(l, x / 2) : l), 0 < !d.length && (m = 0 < c[g].labelAngle ? m - y / 2 : 0 === c[g].labelAngle ? m - y / 2 : m)), c[g].lineCoordinates.x1 = l, c[g].lineCoordinates.x2 = m, c[g].lineCoordinates.width = Math.abs(m - l), c[g].title && (c[g]._titleTextBlock.maxWidth = 0 < c[g].titleMaxWidth && c[g].titleMaxWidth <
                            c[g].lineCoordinates.width ? c[g].titleMaxWidth : c[g].lineCoordinates.width);
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++) b[g].lineCoordinates = {}, l = Math.round(f.x1 + Y + e), m = Math.round(f.x2 - U - X > b[g].chart.width - 10 ? b[g].chart.width - 10 : f.x2 - U - X), b[g] && b[g].labelAutoFit && !r(C) && (0 < !a.length && (l = 0 < b[g].labelAngle ? Math.max(l, C) : 0 === b[g].labelAngle ? Math.max(l, C / 2) : l), 0 < !d.length && (m -= z / 2)), b[g].lineCoordinates.x1 = l, b[g].lineCoordinates.x2 = m, b[g].lineCoordinates.width = Math.abs(m - l), b[g].title && (b[g]._titleTextBlock.maxWidth =
                            0 < b[g].titleMaxWidth && b[g].titleMaxWidth < b[g].lineCoordinates.width ? b[g].titleMaxWidth : b[g].lineCoordinates.width);
                    if (c && 0 < c.length)
                        for (n = [], g = V = 0; g < c.length; g++) n.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateHeight() : 0)), V += n[g] + c[g].margin, K += c[g].margin;
                    ...
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++) b[g] && 0 < b[g]._labels.length && (h = b[g]._labels[0], k = b[g]._labels[b[g]._labels.length - 1], C = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - k.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle)), z = k.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(k.textBlock.angle)) + (k.textBlock.height - k.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(k.textBlock.angle)));
                    if (p.panEnabled)
                    ...
                    if (c && 0 < c.length)
                        for (g = c.length - 1; 0 <= g; g--) k = Math.round(f.y2), h = Math.round(f.y2 > c[g].chart.height ? c[g].chart.height : f.y2), c[g].lineCoordinates.y1 = k - (n[g] + c[g].margin + W), c[g].lineCoordinates.y2 = k - (n[g] + c[g].margin + W), "inside" === c[g].labelPlacement && 0 < g && (c[g].lineCoordinates.y1 = c[g].lineCoordinates.y1 + n[g] - (c[g]._titleTextBlock ? c[g]._titleTextBlock.height : 0) - ("inside" ===
                            c[g].tickPlacement ? c[g].tickLength : 0), c[g].lineCoordinates.y2 = c[g].lineCoordinates.y1 + c[g].lineThickness / 2), c[g].bounds = {
                            x1: l,
                            y1: k - (n[g] + W + c[g].margin),
                            x2: m,
                            y2: h - (W + c[g].margin),
                            width: m - l,
                            height: n[g]
                        }, c[g].title && (c[g]._titleTextBlock.maxWidth = 0 < c[g].titleMaxWidth && c[g].titleMaxWidth < c[g].lineCoordinates.width ? c[g].titleMaxWidth : c[g].lineCoordinates.width), W += n[g] + c[g].margin;
                    if (b && 0 < b.length)
                        for (g = b.length - 1; 0 <= g; g--) b[g] && (k = Math.round(f.y1), h = Math.round(f.y1 + (B[g] + b[g].margin + G)), b[g].lineCoordinates.y1 =
                            h, b[g].lineCoordinates.y2 = h, "inside" === b[g].labelPlacement && 0 < g && (b[g].lineCoordinates.y1 = h - B[g] + (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0)), b[g].bounds = {
                                x1: l,
                                y1: k + (b[g].margin + G),
                                x2: m,
                                y2: h,
                    ...
                    if (a && 0 < a.length)
                        for (g = 0; g < a.length; g++) {
                            K = a[g]._labels && 0 < a[g]._labels.length ? a[g]._labels[0].textBlock.fontSize /
                                2 : 0;
                            l = Math.round(f.x1 + e);
                            k = b && 0 < b.length ? Math.round(b[0] ? b[0].lineCoordinates.y2 : f.y1 < Math.max(K, 10) ? Math.max(K, 10) : f.y1) : f.y1 < Math.max(K, 10) ? Math.max(K, 10) : f.y1;
                            m = Math.round(f.x1 + Y + e);
                            h = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - V > p.height - Math.max(K, 10) ? p.height - Math.max(K, 10) : f.y2 - V) : f.y2 > p.height - Math.max(K, 10) ? p.height - Math.max(K, 10) : f.y2;
                            if (c && 0 < c.length)
                    ...
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++) {
                            ...
                            "inside" === d[g].labelPlacement && 0 < g && (d[g].lineCoordinates.x1 = d[g].lineCoordinates.x1 + (u[g] - (d[g]._titleTextBlock ? d[g]._titleTextBlock.height : 0) - 2) - ("outside" === d[g].tickPlacement ? d[g].tickLength : 0), d[g].lineCoordinates.x2 = d[g].lineCoordinates.x1 + d[g].lineThickness / 2);
                            d[g].bounds = {
                    ...
                    if (0 < w) {
                        ...
                        if (c && 0 < c.length)
                            for (g = 0; g < c.length; g++) J = D[w - 1][g] === D[w][g] ? !0 : !1;
                        else J = !0;
                        if (b && 0 < b.length)
                            for (g = 0; g < b.length; g++) L = s[w - 1][g] === s[w][g] ? !0 : !1;
                        else L = !0
                    }
                    if (v && H && J && L) break;
                    w++
        ...
        $.prototype.render = function(a, d, c) {
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    var u = null;
                    if ("bottom" === this.parent._position || "top" === this.parent._position) v = this.parent.dataSeries[0].axisX.convertPixelToValue({
                        y: d
                    });
                    else if ("left" === this.parent._position || "right" === this.parent._position) v = this.parent.convertPixelToValue({
                        y: d
                    });
                    for (var y = 0; y < this.parent.dataSeries.length; y++)(u = this.parent.dataSeries[y].getDataPointAtX(v, !0)) && 0 <= u.index && (u.dataSeries = this.parent.dataSeries[y], null !== u.dataPoint.y && u.dataSeries.visible &&
                        p.push(u));
                    u = null;
                    ...
                    if ("rangeBar" === p[0].dataSeries.type || "error" === p[0].dataSeries.type)
                        for (var u = Math.abs(a - this.parent.convertValueToPixel(p[y].dataPoint.y[0])), s = 0, v = 0; v < p.length; v++)
                            if (p[v].dataPoint.y && p[v].dataPoint.y.length)
                                for (var x = 0; x < p[v].dataPoint.y.length; x++) s = Math.abs(a - this.parent.convertValueToPixel(p[v].dataPoint.y[x])), s < u && (u = s, y = v);
                            else s =
                                Math.abs(a - this.parent.convertValueToPixel(p[v].dataPoint.y)), s < u && (u = s, y = v);
                    else if ("stackedBar" === p[0].dataSeries.type)
                        for (var u = Math.abs(a - this.parent.convertValueToPixel(p[0].dataPoint.y)), E = s = 0, v = y = 0; v < p.length; v++)
                            if (p[v].dataPoint.y && p[v].dataPoint.y.length)
                                for (x = 0; x < p[v].dataPoint.y.length; x++) s = Math.abs(a - this.parent.convertValueToPixel(p[v].dataPoint.y[x])), s < u && (u = s, y = v);
                            else E += p[v].dataPoint.y, s = Math.abs(a - this.parent.convertValueToPixel(E)), s < u && (u = s, y = v);
                    else if ("stackedBar100" === p[0].dataSeries.type)
                        for (var u =
                                Math.abs(a - this.parent.convertValueToPixel(p[0].dataPoint.y)), C = E = s = 0, v = 0; v < p.length; v++)
                            if (p[v].dataPoint.y && p[v].dataPoint.y.length)
                                for (x = 0; x < p[v].dataPoint.y.length; x++) s = Math.abs(a - this.parent.convertValueToPixel(p[v].dataPoint.y[x])), s < u && (u = s, y = v);
                            else E += p[v].dataPoint.y, C = p[v].dataPoint.x.getTime ? p[v].dataPoint.x.getTime() : p[v].dataPoint.x, C = 100 * (E / p[v].dataSeries.plotUnit.dataPointYSums[C]), s = Math.abs(a - this.parent.convertValueToPixel(C)), s < u && (u = s, y = v);
                    else
                        for (u = Math.abs(a - this.parent.convertValueToPixel(p[0].dataPoint.y)),
                            v = y = s = 0; v < p.length; v++)
                            if (p[v].dataPoint.y && p[v].dataPoint.y.length)
                                for (x = 0; x < p[v].dataPoint.y.length; x++) s = Math.abs(a - this.parent.convertValueToPixel(p[v].dataPoint.y[x])), s < u && (u = s, y = v);
                            else s = Math.abs(a - this.parent.convertValueToPixel(p[v].dataPoint.y)), s < u && (u = s, y = v);
                    x = p[y];
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        ...
                        if ("rangeBar" === this.parent.dataSeries[y].type || "error" === this.parent.dataSeries[y].type) {
                            ...
                            for (v = s = 0; v < x.dataPoint.y.length; v++) s = Math.abs(a - this.parent.convertValueToPixel(x.dataPoint.y[v])), s < u && (u = s, b = v);
                            ...
                            h.text = this.labelFormatter ? this.labelFormatter({
                                ...
                                }) : r(this.options.label) ? ea(c ? c : x.dataPoint.y[b], this.valueFormatString, this.chart._cultureInfo) :
                                this.label
                        } else if ("stackedBar" === this.parent.dataSeries[y].type) {
                            u = Math.abs(a - this.parent.convertValueToPixel(p[0].dataPoint.y));
                            E = s = 0;
                            for (v = y; 0 <= v; v--) E += p[v].dataPoint.y, s = Math.abs(a - this.parent.convertValueToPixel(E)), s < u && (u = s, b = v);
                            ...
                            u = Math.abs(a - this.parent.convertValueToPixel(p[0].dataPoint.y));
                            C = E = s = 0;
                            for (v = y; 0 <= v; v--) E += p[v].dataPoint.y, C = p[v].dataPoint.x.getTime ? p[v].dataPoint.x.getTime() : p[v].dataPoint.x, C = 100 * (E / p[v].dataSeries.plotUnit.dataPointYSums[C]), s = Math.abs(a - this.parent.convertValueToPixel(C)), s < u && (u = s, b = v);
                            ...
                            h.text = this.labelFormatter ? this.labelFormatter({
                                ...
                                crosshair: this.options,
                                value: c ? c : C
                            }) : r(this.options.label) ? ea(c ? c : C, this.valueFormatString, this.chart._cultureInfo) : this.label
                        } else m = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataPoint.y) << 0) + 0.5 : this.parent.convertValueToPixel(x.dataPoint.y) << 0, this.value = x.dataPoint.y, h.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                            value: c ? c : x.dataPoint.y
                        }) : r(this.options.label) ? ea(c ? c : x.dataPoint.y, this.valueFormatString, this.chart._cultureInfo) : this.label;
                        b = e = m;
                        ...
                        h.y + h.height >
                            this.chart.bounds.y2 ? h.y = this.chart.bounds.y2 - h.height : h.y < this.chart.bounds.y1 && (h.y = this.chart.bounds.y1)
                    } else if ("left" === this.parent._position || "right" === this.parent._position) {
                        f = k = w = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataPoint.x) << 0) + 0.5 : this.parent.convertValueToPixel(x.dataPoint.x) << 0;
                        ...
                        if (this.parent.labels)
                            for (p = Math.ceil(this.parent.interval), v = 0; v < this.parent.viewportMaximum; v +=
                                p)
                                if (this.parent.labels[v]) C = !0;
                                else {
                                    C = !1;
                                    break
                                } if (C) {
                            if ("axisX" === this.parent.type)
                                for (v = this.parent.convertPixelToValue({
                                        y: d
                                    }), u = null, y = 0; y < this.parent.dataSeries.length; y++)(u = this.parent.dataSeries[y].getDataPointAtX(v, !0)) && 0 <= u.index && (h.text = this.labelFormatter ? this.labelFormatter({
                                    chart: this.chart,
                                    axis: this.parent.options,
                                    crosshair: this.options,
                                    value: x.dataPoint.x
                                }) : r(this.options.label) ? u.dataPoint.label : this.label)
                            ...
                            crosshair: this.options,
                            value: c ? c : x.dataPoint.x
                        }) : r(this.options.label) ? ea(c ? c : x.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label);
                        this.value = x.dataPoint.x;
                        h.y = k + h.fontSize / 2 - h.measureText().height /
                            2 + 2;
                    ...
                    v = this.parent.convertPixelToValue({
                        x: a
                    });
                    for (y = 0; y < this.parent.dataSeries.length; y++)(u =
                        this.parent.dataSeries[y].getDataPointAtX(v, !0)) && 0 <= u.index && (u.dataSeries = this.parent.dataSeries[y], null !== u.dataPoint.y && u.dataSeries.visible && p.push(u));
                    if (0 === p.length) return;
                    p.sort(function(a, b) {
                        return a.distance - b.distance
                    });
                    x = p[0];
                    b = e = m = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataPoint.x) << 0) + 0.5 : this.parent.convertValueToPixel(x.dataPoint.x) << 0;
                    f = this.chart.plotArea.y1;
                    k = this.chart.plotArea.y2;
                    this.bounds = {
                        x1: b - n / 2,
                    ...
                    C = !1;
                    if (this.parent.labels)
                        for (p = Math.ceil(this.parent.interval),
                            v = 0; v < this.parent.viewportMaximum; v += p)
                            if (this.parent.labels[v]) C = !0;
                            else {
                                C = !1;
                                break
                    ...
                    !r(this.parent.dataSeries) && 0 < this.parent.dataSeries.length && (v = this.parent.dataSeries[0].axisX.convertPixelToValue({
                        x: a
                    }));
                    for (y = 0; y < this.parent.dataSeries.length; y++)(u = this.parent.dataSeries[y].getDataPointAtX(v, !0)) && 0 <= u.index && (u.dataSeries = this.parent.dataSeries[y], null !== u.dataPoint.y && u.dataSeries.visible && p.push(u));
                    if (0 === p.length) return;
                    p.sort(function(a, b) {
                        return a.distance - b.distance
                    });
                    y = 0;
                    if ("rangeColumn" === p[0].dataSeries.type || "rangeArea" === p[0].dataSeries.type || "error" === p[0].dataSeries.type || "rangeSplineArea" === p[0].dataSeries.type || "candlestick" === p[0].dataSeries.type || "ohlc" === p[0].dataSeries.type ||
                        "boxAndWhisker" === p[0].dataSeries.type)
                        for (u = Math.abs(d - this.parent.convertValueToPixel(p[0].dataPoint.y[0])), v = s = 0; v < p.length; v++)
                            if (p[v].dataPoint.y && p[v].dataPoint.y.length)
                                for (x = 0; x < p[v].dataPoint.y.length; x++) s = Math.abs(d - this.parent.convertValueToPixel(p[v].dataPoint.y[x])), s < u && (u = s, y = v);
                            else s = Math.abs(d - this.parent.convertValueToPixel(p[v].dataPoint.y)), s < u && (u = s, y = v);
                        ...
                        for (u = Math.abs(d - this.parent.convertValueToPixel(p[0].dataPoint.y)),
                            v = E = s = 0; v < p.length; v++)
                            if (p[v].dataPoint.y && p[v].dataPoint.y.length)
                                for (x = 0; x < p[v].dataPoint.y.length; x++) s = Math.abs(d - this.parent.convertValueToPixel(p[v].dataPoint.y[x])), s < u && (u = s, y = v);
                            else E += p[v].dataPoint.y, s = Math.abs(d - this.parent.convertValueToPixel(E)), s < u && (u = s, y = v);
                    else if ("stackedColumn100" === p[0].dataSeries.type || "stackedArea100" === p[0].dataSeries.type)
                        for (u = Math.abs(d - this.parent.convertValueToPixel(p[0].dataPoint.y)), v = C = E = s = 0; v < p.length; v++)
                            if (p[v].dataPoint.y && p[v].dataPoint.y.length)
                                for (x =
                                    0; x < p[v].dataPoint.y.length; x++) s = Math.abs(d - this.parent.convertValueToPixel(p[v].dataPoint.y[x])), s < u && (u = s, y = v);
                            else E += p[v].dataPoint.y, C = p[v].dataPoint.x.getTime ? p[v].dataPoint.x.getTime() : p[v].dataPoint.x, C = 100 * (E / p[v].dataSeries.plotUnit.dataPointYSums[C]), s = Math.abs(d - this.parent.convertValueToPixel(C)), s < u && (u = s, y = v);
                    else
                        for (u = Math.abs(d - this.parent.convertValueToPixel(p[0].dataPoint.y)), v = s = 0; v < p.length; v++)
                            if (p[v].dataPoint.y && p[v].dataPoint.y.length)
                                for (x = 0; x < p[v].dataPoint.y.length; x++) s =
                                    Math.abs(d - this.parent.convertValueToPixel(p[v].dataPoint.y[x])), s < u && (u = s, y = v);
                            else s = Math.abs(d - this.parent.convertValueToPixel(p[v].dataPoint.y)), s < u && (u = s, y = v);
                    x = p[y];
                    b = 0;
                    if ("rangeColumn" === this.parent.dataSeries[y].type || "rangeArea" === this.parent.dataSeries[y].type || "error" === this.parent.dataSeries[y].type || "rangeSplineArea" === this.parent.dataSeries[y].type || "candlestick" === this.parent.dataSeries[y].type || "ohlc" === this.parent.dataSeries[y].type || "boxAndWhisker" === this.parent.dataSeries[y].type) {
                        ...
                        for (v = s = 0; v < x.dataPoint.y.length; v++) s = Math.abs(d - this.parent.convertValueToPixel(x.dataPoint.y[v])), s < u && (u = s, b = v);
                        ...
                        h.text = this.labelFormatter ? this.labelFormatter({
                            ...
                            crosshair: this.options,
                            value: c ? c : x.dataPoint.y[b]
                        }) : r(this.options.label) ? ea(c ? c : x.dataPoint.y[b], this.valueFormatString,
                        ...
                        E = s = 0;
                        for (v = y; 0 <= v; v--) E += p[v].dataPoint.y, s = Math.abs(d - this.parent.convertValueToPixel(E)), s < u && (u = s, b = v);
                        ...
                        u = Math.abs(d - this.parent.convertValueToPixel(p[0].dataPoint.y));
                        E = s = 0;
                        for (v = y; 0 <= v; v--) E += p[v].dataPoint.y, C = p[v].dataPoint.x.getTime ? p[v].dataPoint.x.getTime() : p[v].dataPoint.x, C = 100 * (E / p[v].dataSeries.plotUnit.dataPointYSums[C]),
                            s = Math.abs(d - this.parent.convertValueToPixel(C)), s < u && (u = s, b = v);
                        ...
                        this.value = C
                    } else "waterfall" === this.parent.dataSeries[y].type ? (w = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataSeries.dataPointEOs[x.index].cumulativeSum) <<
                    ...
                    }) : r(this.options.label) ? ea(c ? c : x.dataSeries.dataPointEOs[x.index].cumulativeSum, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = x.dataSeries.dataPointEOs[x.index].cumulativeSum) : (w = 1 === q.lineWidth % 2 ? (r(a) ? d : this.parent.convertValueToPixel(x.dataPoint.y) <<
                        0) + 0.5 : r(a) ? d : this.parent.convertValueToPixel(x.dataPoint.y) << 0, h.text = this.labelFormatter ? this.labelFormatter({
                        chart: this.chart,
                        axis: this.parent.options,
                        crosshair: this.options,
                        value: x.dataPoint.y
                    }) : r(this.options.label) ? ea(c ? c : x.dataPoint.y, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = x.dataPoint.y);
                    f = k = w;
                    b = this.chart.plotArea.x1;
                    e = this.chart.plotArea.x2;
                    this.bounds = {
                ...
                if ("left" === this.parent._position || "right" === this.parent._position) "left" === this.parent._position && h.x < this.chart.bounds.x1 && (h.x = this.chart.bounds.x1), "right" === this.parent._position && h.x + h.measureText().width > this.chart.bounds.x2 && (h.x = this.chart.bounds.x2 - h.measureText().width), k >= this.parent.convertValueToPixel(this.parent.reversed ? this.parent.viewportMinimum : this.parent.viewportMaximum) && f <= this.parent.convertValueToPixel(this.parent.reversed ?
                    this.parent.viewportMaximum : this.parent.viewportMinimum) && (0 < n && (q.moveTo(b, f), q.lineTo(e, k), q.stroke(), this._hidden = !1), q.restore(), !r(h.text) && ("number" === typeof h.text.valueOf() || 0 < h.text.length) && h.render(!0))
            } else {
                if ("bottom" === this.parent._position || "top" === this.parent._position) b = e = m = 1 === q.lineWidth % 2 ? (a << 0) + 0.5 : a << 0, f = this.chart.plotArea.y1, k = this.chart.plotArea.y2, this.bounds = {
                    x1: b - n / 2,
                    y1: f,
                    x2: e + n / 2,
                    y2: k
                };
                else if ("left" === this.parent._position || "right" === this.parent._position) f = k = w = 1 === q.lineWidth %
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement)
                    if ("left" === this.parent._position || "right" === this.parent._position) {
                        C = !1;
                        if (this.parent.labels)
                            for (p = Math.ceil(this.parent.interval), v = 0; v < this.parent.viewportMaximum; v += p)
                                if (this.parent.labels[v]) C = !0;
                                else {
                                    C = !1;
                                    break
                            ...
                            if ("axisX" === this.parent.type)
                                for (v = this.parent.convertPixelToValue({
                                        y: d
                                    }), u = null, y = 0; y < this.parent.dataSeries.length; y++)(u =
                                    this.parent.dataSeries[y].getDataPointAtX(v, !0)) && 0 <= u.index && (h.text = this.labelFormatter ? this.labelFormatter({
                                    chart: this.chart,
                                    axis: this.parent.options,
                                    crosshair: this.options,
                        ...
                        if ("bottom" === this.parent._position || "top" === this.parent._position) h.text = this.labelFormatter ? this.labelFormatter({
                            ...
                            crosshair: this.options,
                            value: c ? c : this.parent.convertPixelToValue(a)
                        }) : r(this.options.label) ? ea(c ? c : this.parent.convertPixelToValue(a), this.valueFormatString, this.chart._cultureInfo) : this.label, h.x = b - h.measureText().width / 2, h.x + h.width > this.chart.bounds.x2 && (h.x = this.chart.bounds.x2 - h.width), h.x < this.chart.bounds.x1 && (h.x = this.chart.bounds.x1), "bottom" === this.parent._position ? h.y = this.parent.lineCoordinates.y2 + h.fontSize / 2 + 2 : "top" === this.parent._position && (h.y = this.parent.lineCoordinates.y1 - h.height + h.fontSize / 2 + 2)
                    }
                else if ("bottom" ===
                    ...
                    if (this.parent.labels)
                        ...
                        if ("axisX" === this.parent.type)
                            for (v = this.parent.convertPixelToValue({
                                ...
                                crosshair: this.options,
                                value: c ? c : this.parent.convertPixelToValue(a)
                            }) : r(this.options.label) ? c ? c : u.dataPoint.label : this.label)
                    } else "dateTime" === this.parent.valueType ? h.text = this.labelFormatter ? this.labelFormatter({
                        chart: this.chart,
                        axis: this.parent.options,
                        crosshair: this.options,
                    ...
                    }) : r(this.options.label) ? ea(c ? c : this.parent.convertPixelToValue(a), this.valueFormatString, this.chart._cultureInfo) : this.label);
                    h.x = b - h.measureText().width / 2;
                    h.x + h.width > this.chart.bounds.x2 && (h.x = this.chart.bounds.x2 - h.width);
                    h.x < this.chart.bounds.x1 && (h.x = this.chart.bounds.x1);
                    "bottom" === this.parent._position ? h.y = this.parent.lineCoordinates.y2 + h.fontSize / 2 + 2 : "top" === this.parent._position &&
                        ...
                        crosshair: this.options,
                        value: c ? c : this.parent.convertPixelToValue(d)
                    }) : r(this.options.label) ? ea(c ? c : this.parent.convertPixelToValue(d), this.valueFormatString, this.chart._cultureInfo) : this.label, h.y = d + h.fontSize / 2 - h.measureText().height / 2 + 2, h.y - h.fontSize / 2 < this.chart.bounds.y1 ? h.y =
                ...
                0 < n && (q.moveTo(b, f), q.lineTo(e, k), q.stroke(), this._hidden = !1);
                q.restore();
            ...
            if (!this.chart.disableToolTip) {
                ...
                if (this.shared && this.enabled &&
                    ...
                    if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                        ...
                        if (this.chart.axisX)
                            for (var u = 0; u < this.chart.axisX.length; u++) {
                                for (var k = this.chart.axisX[u].convertPixelToValue({
                                        y: d
                                    }), h = null, b = 0; b < this.chart.axisX[u].dataSeries.length; b++)(h = this.chart.axisX[u].dataSeries[b].getDataPointAtX(k, c)) && 0 <= h.index && (h.dataSeries = this.chart.axisX[u].dataSeries[b], null !== h.dataPoint.y && m.push(h));
                                h = null
                            }
                        if (this.chart.axisX2)
                            for (u = 0; u < this.chart.axisX2.length; u++) {
                                ...
                                h = null;
                                for (b = 0; b < this.chart.axisX2[u].dataSeries.length; b++)(h = this.chart.axisX2[u].dataSeries[b].getDataPointAtX(k, c)) && 0 <= h.index && (h.dataSeries = this.chart.axisX2[u].dataSeries[b], null !== h.dataPoint.y && m.push(h));
                                h = null
                            }
                    } else {
                        m = [];
                        if (this.chart.axisX)
                            for (u = 0; u < this.chart.axisX.length; u++)
                                for (k = this.chart.axisX[u].convertPixelToValue({
                                        x: a
                                    }), h = null, b = 0; b < this.chart.axisX[u].dataSeries.length; b++)(h = this.chart.axisX[u].dataSeries[b].getDataPointAtX(k,
                                    c)) && 0 <= h.index && (h.dataSeries = this.chart.axisX[u].dataSeries[b], null !== h.dataPoint.y && m.push(h));
                        if (this.chart.axisX2)
                            for (u = 0; u < this.chart.axisX2.length; u++)
                                for (k = this.chart.axisX2[u].convertPixelToValue({
                                        x: a
                                    }), h = null, b = 0; b < this.chart.axisX2[u].dataSeries.length; b++)(h = this.chart.axisX2[u].dataSeries[b].getDataPointAtX(k, c)) && 0 <= h.index && (h.dataSeries = this.chart.axisX2[u].dataSeries[b], null !== h.dataPoint.y && m.push(h))
                    }
                    ...
                    if (h = this.chart.getDataPointAtXY(a, d, c)) this.currentDataPointIndex = h.dataPointIndex, this.currentSeriesIndex = h.dataSeries.index;
                        ...
                        if (h = $a(a, d, this.chart._eventManager.ghostCtx), 0 < h && "undefined" !== typeof this.chart._eventManager.objectMap[h]) {
        ...
        X.prototype.getToolTipInnerHTML = function(a) {
            a = a.entries;
            for (var d = null, c = null, b = null, e = 0, f = "", k = !0, m = 0; m < a.length; m++)
        ...
        X.prototype.showAtX = function(a, d) {
            ...
            if (this.shared)
                for (var k = 0; k < this.chart.data.length; k++) c = this.chart.data[k], (b = c.getDataPointAtX(a, !1)) && (b.dataPoint && !r(b.dataPoint.y) && c.visible) && (b.dataSeries = c, f.push(b));
        ...
        da.prototype.reset = function() {
            ...
            this.previousDataPointEventObject = null;
            this.eventObjects = [];
            w && (this.ghostCtx.clearRect(0, 0, this.chart.width,
