 ...
 *   https://datatables.net/download/#dt/dt-1.10.23/b-1.6.5/b-flash-1.6.5/r-2.2.7/sc-2.0.3/sb-1.0.1
 *
 * Included libraries:
 *   DataTables 1.10.23, Buttons 1.6.5, Flash export 1.6.5, Responsive 2.2.7, Scroller 2.0.3, SearchBuilder 1.0.1
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"dt/dt-1.10.23/b-1.6.5/b-flash-1.6.5/r-2.2.7/sc-2.0.3/sb-1.0.1",
